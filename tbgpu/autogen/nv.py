...
from tbgpu.support.c import _IO, _IOW, _IOR, _IOWR
...
NVDM_PAYLOAD_COT.register_fields([
  ("version", NvU16, 0),
  ("size", NvU16, 2),
  ("gspFmcSysmemOffset", NvU64, 4),
  ("frtsSysmemOffset", NvU64, 12),
  ("frtsSysmemSize", NvU32, 20),
  ("frtsVidmemOffset", NvU64, 24),
  ("frtsVidmemSize", NvU32, 32),
  ("hash384", c.Array[NvU32, Literal[12]], 36),
  ("publicKey", c.Array[NvU32, Literal[96]], 84),
  ("signature", c.Array[NvU32, Literal[96]], 468),
  ("gspBootArgsSysmemOffset", NvU64, 852),
])
...
MESSAGE_QUEUE_INIT_ARGUMENTS.register_fields([
  ("sharedMemPhysAddr", NvU64, 0),
  ("pageTableEntryCount", NvU32, 8),
  ("cmdQueueOffset", NvLength, 16),
  ("statQueueOffset", NvLength, 24),
])
...
GSP_ARGUMENTS_CACHED.register_fields([
  ("messageQueueInitArguments", MESSAGE_QUEUE_INIT_ARGUMENTS, 0),
  ("srInitArguments", GSP_SR_INIT_ARGUMENTS, 32),
  ("gpuInstance", NvU32, 44),
  ("bDmemStack", NvBool, 48),
  ("profilerArgs", GSP_ARGUMENTS_CACHED_profilerArgs, 56),
])
GSP_DMA_TARGET: dict[int, str] = {
  (GSP_DMA_TARGET_LOCAL_FB := 0): "GSP_DMA_TARGET_LOCAL_FB",
  (GSP_DMA_TARGET_COHERENT_SYSTEM := 1): "GSP_DMA_TARGET_COHERENT_SYSTEM",
  (GSP_DMA_TARGET_NONCOHERENT_SYSTEM := 2): "GSP_DMA_TARGET_NONCOHERENT_SYSTEM",
  (GSP_DMA_TARGET_COUNT := 3): "GSP_DMA_TARGET_COUNT",
}
...
struct_GSP_ACR_BOOT_GSP_RM_PARAMS.register_fields([
  ("target", ctypes.c_uint32, 0),
  ("gspRmDescSize", NvU32, 4),
  ("gspRmDescOffset", NvU64, 8),
  ("wprCarveoutOffset", NvU64, 16),
  ("wprCarveoutSize", NvU32, 24),
  ("bIsGspRmBoot", NvBool, 28),
])
...
struct_GSP_FMC_BOOT_PARAMS.register_fields([
  ("initParams", GSP_FMC_INIT_PARAMS, 0),
  ("bootGspRmParams", GSP_ACR_BOOT_GSP_RM_PARAMS, 8),
  ("gspRmParams", GSP_RM_PARAMS, 40),
  ("gspSpdmParams", GSP_SPDM_PARAMS, 56),
])
...
GspFwWprMeta.register_fields([
  ("magic", NvU64, 0),
  ("revision", NvU64, 8),
  ("sysmemAddrOfRadix3Elf", NvU64, 16),
  ("sizeOfRadix3Elf", NvU64, 24),
  ("sysmemAddrOfBootloader", NvU64, 32),
  ("sizeOfBootloader", NvU64, 40),
  ("bootloaderCodeOffset", NvU64, 48),
  ("bootloaderDataOffset", NvU64, 56),
  ("bootloaderManifestOffset", NvU64, 64),
  ("sysmemAddrOfSignature", NvU64, 72),
  ("sizeOfSignature", NvU64, 80),
  ("gspFwHeapFreeListWprOffset", NvU32, 72),
  ("unused0", NvU32, 76),
  ("unused1", NvU64, 80),
  ("gspFwRsvdStart", NvU64, 88),
  ("nonWprHeapOffset", NvU64, 96),
  ("nonWprHeapSize", NvU64, 104),
  ("gspFwWprStart", NvU64, 112),
  ("gspFwHeapOffset", NvU64, 120),
  ("gspFwHeapSize", NvU64, 128),
  ("gspFwOffset", NvU64, 136),
  ("bootBinOffset", NvU64, 144),
  ("frtsOffset", NvU64, 152),
  ("frtsSize", NvU64, 160),
  ("gspFwWprEnd", NvU64, 168),
  ("fbSize", NvU64, 176),
  ("vgaWorkspaceOffset", NvU64, 184),
  ("vgaWorkspaceSize", NvU64, 192),
  ("bootCount", NvU64, 200),
  ("partitionRpcAddr", NvU64, 208),
  ("partitionRpcRequestOffset", NvU16, 216),
  ("partitionRpcReplyOffset", NvU16, 218),
  ("elfCodeOffset", NvU32, 220),
  ("elfDataOffset", NvU32, 224),
  ("elfCodeSize", NvU32, 228),
  ("elfDataSize", NvU32, 232),
  ("lsUcodeVersion", NvU32, 236),
  ("partitionRpcPadding", c.Array[NvU32, Literal[4]], 208),
  ("sysmemAddrOfCrashReportQueue", NvU64, 224),
  ("sizeOfCrashReportQueue", NvU32, 232),
  ("lsUcodeVersionPadding", c.Array[NvU32, Literal[1]], 236),
  ("gspFwHeapVfPartitionCount", NvU8, 240),
  ("flags", NvU8, 241),
  ("padding", c.Array[NvU8, Literal[2]], 242),
  ("pmuReservedSize", NvU32, 244),
  ("verified", NvU64, 248),
])
...
GspFwSRMeta.register_fields([
  ("magic", NvU64, 0),
  ("revision", NvU64, 8),
  ("sysmemAddrOfSuspendResumeData", NvU64, 16),
  ("sizeOfSuspendResumeData", NvU64, 24),
  ("internal", c.Array[NvU32, Literal[32]], 32),
  ("flags", NvU32, 160),
  ("subrevision", NvU32, 164),
  ("padding", c.Array[NvU32, Literal[22]], 168),
])
...
RM_RISCV_UCODE_DESC.register_fields([
  ("version", NvU32, 0),
  ("bootloaderOffset", NvU32, 4),
  ("bootloaderSize", NvU32, 8),
  ("bootloaderParamOffset", NvU32, 12),
  ("bootloaderParamSize", NvU32, 16),
  ("riscvElfOffset", NvU32, 20),
  ("riscvElfSize", NvU32, 24),
  ("appVersion", NvU32, 28),
  ("manifestOffset", NvU32, 32),
  ("manifestSize", NvU32, 36),
  ("monitorDataOffset", NvU32, 40),
  ("monitorDataSize", NvU32, 44),
  ("monitorCodeOffset", NvU32, 48),
  ("monitorCodeSize", NvU32, 52),
  ("bIsMonitorEnabled", NvU32, 56),
  ("swbromCodeOffset", NvU32, 60),
  ("swbromCodeSize", NvU32, 64),
  ("swbromDataOffset", NvU32, 68),
  ("swbromDataSize", NvU32, 72),
  ("fbReservedSize", NvU32, 76),
  ("bSignedAsCode", NvU32, 80),
])
RPC_GR_BUFFER_TYPE: dict[int, str] = {
  (RPC_GR_BUFFER_TYPE_GRAPHICS := 0): "RPC_GR_BUFFER_TYPE_GRAPHICS",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_ZCULL := 1): "RPC_GR_BUFFER_TYPE_GRAPHICS_ZCULL",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_GRAPHICS_PM := 2): "RPC_GR_BUFFER_TYPE_GRAPHICS_GRAPHICS_PM",
  (RPC_GR_BUFFER_TYPE_COMPUTE_PREEMPT := 3): "RPC_GR_BUFFER_TYPE_COMPUTE_PREEMPT",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_PATCH := 4): "RPC_GR_BUFFER_TYPE_GRAPHICS_PATCH",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_BUNDLE_CB := 5): "RPC_GR_BUFFER_TYPE_GRAPHICS_BUNDLE_CB",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_PAGEPOOL_GLOBAL := 6): "RPC_GR_BUFFER_TYPE_GRAPHICS_PAGEPOOL_GLOBAL",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_ATTRIBUTE_CB := 7): "RPC_GR_BUFFER_TYPE_GRAPHICS_ATTRIBUTE_CB",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_RTV_CB_GLOBAL := 8): "RPC_GR_BUFFER_TYPE_GRAPHICS_RTV_CB_GLOBAL",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_GFXP_POOL := 9): "RPC_GR_BUFFER_TYPE_GRAPHICS_GFXP_POOL",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_GFXP_CTRL_BLK := 10): "RPC_GR_BUFFER_TYPE_GRAPHICS_GFXP_CTRL_BLK",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_FECS_EVENT := 11): "RPC_GR_BUFFER_TYPE_GRAPHICS_FECS_EVENT",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_PRIV_ACCESS_MAP := 12): "RPC_GR_BUFFER_TYPE_GRAPHICS_PRIV_ACCESS_MAP",
  (RPC_GR_BUFFER_TYPE_GRAPHICS_MAX := 13): "RPC_GR_BUFFER_TYPE_GRAPHICS_MAX",
}
FECS_ERROR_EVENT_TYPE: dict[int, str] = {
  (FECS_ERROR_EVENT_TYPE_NONE := 0): "FECS_ERROR_EVENT_TYPE_NONE",
  (FECS_ERROR_EVENT_TYPE_BUFFER_RESET_REQUIRED := 1): "FECS_ERROR_EVENT_TYPE_BUFFER_RESET_REQUIRED",
  (FECS_ERROR_EVENT_TYPE_BUFFER_FULL := 2): "FECS_ERROR_EVENT_TYPE_BUFFER_FULL",
  (FECS_ERROR_EVENT_TYPE_MAX := 3): "FECS_ERROR_EVENT_TYPE_MAX",
}
NV_RPC_UPDATE_PDE_BAR_TYPE: dict[int, str] = {
  (NV_RPC_UPDATE_PDE_BAR_1 := 0): "NV_RPC_UPDATE_PDE_BAR_1",
  (NV_RPC_UPDATE_PDE_BAR_2 := 1): "NV_RPC_UPDATE_PDE_BAR_2",
  (NV_RPC_UPDATE_PDE_BAR_INVALID := 2): "NV_RPC_UPDATE_PDE_BAR_INVALID",
}
...
struct_VIRTUAL_DISPLAY_GET_MAX_RESOLUTION_PARAMS.register_fields([
  ("headIndex", NvU32, 0),
  ("maxHResolution", NvU32, 4),
  ("maxVResolution", NvU32, 8),
])
...
GPU_RECOVERY_EVENT_TYPE: dict[int, str] = {
  (GPU_RECOVERY_EVENT_TYPE_REFRESH := 0): "GPU_RECOVERY_EVENT_TYPE_REFRESH",
  (GPU_RECOVERY_EVENT_TYPE_GPU_DRAIN_P2P := 1): "GPU_RECOVERY_EVENT_TYPE_GPU_DRAIN_P2P",
  (GPU_RECOVERY_EVENT_TYPE_SYS_REBOOT := 2): "GPU_RECOVERY_EVENT_TYPE_SYS_REBOOT",
}
rpc_fns: dict[int, str] = {
  (NV_VGPU_MSG_FUNCTION_NOP := 0): "NV_VGPU_MSG_FUNCTION_NOP",
  (NV_VGPU_MSG_FUNCTION_SET_GUEST_SYSTEM_INFO := 1): "NV_VGPU_MSG_FUNCTION_SET_GUEST_SYSTEM_INFO",
  (NV_VGPU_MSG_FUNCTION_ALLOC_ROOT := 2): "NV_VGPU_MSG_FUNCTION_ALLOC_ROOT",
  (NV_VGPU_MSG_FUNCTION_ALLOC_DEVICE := 3): "NV_VGPU_MSG_FUNCTION_ALLOC_DEVICE",
  (NV_VGPU_MSG_FUNCTION_ALLOC_MEMORY := 4): "NV_VGPU_MSG_FUNCTION_ALLOC_MEMORY",
  (NV_VGPU_MSG_FUNCTION_ALLOC_CTX_DMA := 5): "NV_VGPU_MSG_FUNCTION_ALLOC_CTX_DMA",
  (NV_VGPU_MSG_FUNCTION_ALLOC_CHANNEL_DMA := 6): "NV_VGPU_MSG_FUNCTION_ALLOC_CHANNEL_DMA",
  (NV_VGPU_MSG_FUNCTION_MAP_MEMORY := 7): "NV_VGPU_MSG_FUNCTION_MAP_MEMORY",
  (NV_VGPU_MSG_FUNCTION_BIND_CTX_DMA := 8): "NV_VGPU_MSG_FUNCTION_BIND_CTX_DMA",
  (NV_VGPU_MSG_FUNCTION_ALLOC_OBJECT := 9): "NV_VGPU_MSG_FUNCTION_ALLOC_OBJECT",
  (NV_VGPU_MSG_FUNCTION_FREE := 10): "NV_VGPU_MSG_FUNCTION_FREE",
  (NV_VGPU_MSG_FUNCTION_LOG := 11): "NV_VGPU_MSG_FUNCTION_LOG",
  (NV_VGPU_MSG_FUNCTION_ALLOC_VIDMEM := 12): "NV_VGPU_MSG_FUNCTION_ALLOC_VIDMEM",
  (NV_VGPU_MSG_FUNCTION_UNMAP_MEMORY := 13): "NV_VGPU_MSG_FUNCTION_UNMAP_MEMORY",
  (NV_VGPU_MSG_FUNCTION_MAP_MEMORY_DMA := 14): "NV_VGPU_MSG_FUNCTION_MAP_MEMORY_DMA",
  (NV_VGPU_MSG_FUNCTION_UNMAP_MEMORY_DMA := 15): "NV_VGPU_MSG_FUNCTION_UNMAP_MEMORY_DMA",
  (NV_VGPU_MSG_FUNCTION_GET_EDID := 16): "NV_VGPU_MSG_FUNCTION_GET_EDID",
  (NV_VGPU_MSG_FUNCTION_ALLOC_DISP_CHANNEL := 17): "NV_VGPU_MSG_FUNCTION_ALLOC_DISP_CHANNEL",
  (NV_VGPU_MSG_FUNCTION_ALLOC_DISP_OBJECT := 18): "NV_VGPU_MSG_FUNCTION_ALLOC_DISP_OBJECT",
  (NV_VGPU_MSG_FUNCTION_ALLOC_SUBDEVICE := 19): "NV_VGPU_MSG_FUNCTION_ALLOC_SUBDEVICE",
  (NV_VGPU_MSG_FUNCTION_ALLOC_DYNAMIC_MEMORY := 20): "NV_VGPU_MSG_FUNCTION_ALLOC_DYNAMIC_MEMORY",
  (NV_VGPU_MSG_FUNCTION_DUP_OBJECT := 21): "NV_VGPU_MSG_FUNCTION_DUP_OBJECT",
  (NV_VGPU_MSG_FUNCTION_IDLE_CHANNELS := 22): "NV_VGPU_MSG_FUNCTION_IDLE_CHANNELS",
  (NV_VGPU_MSG_FUNCTION_ALLOC_EVENT := 23): "NV_VGPU_MSG_FUNCTION_ALLOC_EVENT",
  (NV_VGPU_MSG_FUNCTION_SEND_EVENT := 24): "NV_VGPU_MSG_FUNCTION_SEND_EVENT",
  (NV_VGPU_MSG_FUNCTION_REMAPPER_CONTROL := 25): "NV_VGPU_MSG_FUNCTION_REMAPPER_CONTROL",
  (NV_VGPU_MSG_FUNCTION_DMA_CONTROL := 26): "NV_VGPU_MSG_FUNCTION_DMA_CONTROL",
  (NV_VGPU_MSG_FUNCTION_DMA_FILL_PTE_MEM := 27): "NV_VGPU_MSG_FUNCTION_DMA_FILL_PTE_MEM",
  (NV_VGPU_MSG_FUNCTION_MANAGE_HW_RESOURCE := 28): "NV_VGPU_MSG_FUNCTION_MANAGE_HW_RESOURCE",
  (NV_VGPU_MSG_FUNCTION_BIND_ARBITRARY_CTX_DMA := 29): "NV_VGPU_MSG_FUNCTION_BIND_ARBITRARY_CTX_DMA",
  (NV_VGPU_MSG_FUNCTION_CREATE_FB_SEGMENT := 30): "NV_VGPU_MSG_FUNCTION_CREATE_FB_SEGMENT",
  (NV_VGPU_MSG_FUNCTION_DESTROY_FB_SEGMENT := 31): "NV_VGPU_MSG_FUNCTION_DESTROY_FB_SEGMENT",
  (NV_VGPU_MSG_FUNCTION_ALLOC_SHARE_DEVICE := 32): "NV_VGPU_MSG_FUNCTION_ALLOC_SHARE_DEVICE",
  (NV_VGPU_MSG_FUNCTION_DEFERRED_API_CONTROL := 33): "NV_VGPU_MSG_FUNCTION_DEFERRED_API_CONTROL",
  (NV_VGPU_MSG_FUNCTION_REMOVE_DEFERRED_API := 34): "NV_VGPU_MSG_FUNCTION_REMOVE_DEFERRED_API",
  (NV_VGPU_MSG_FUNCTION_SIM_ESCAPE_READ := 35): "NV_VGPU_MSG_FUNCTION_SIM_ESCAPE_READ",
  (NV_VGPU_MSG_FUNCTION_SIM_ESCAPE_WRITE := 36): "NV_VGPU_MSG_FUNCTION_SIM_ESCAPE_WRITE",
  (NV_VGPU_MSG_FUNCTION_SIM_MANAGE_DISPLAY_CONTEXT_DMA := 37): "NV_VGPU_MSG_FUNCTION_SIM_MANAGE_DISPLAY_CONTEXT_DMA",
  (NV_VGPU_MSG_FUNCTION_FREE_VIDMEM_VIRT := 38): "NV_VGPU_MSG_FUNCTION_FREE_VIDMEM_VIRT",
  (NV_VGPU_MSG_FUNCTION_PERF_GET_PSTATE_INFO := 39): "NV_VGPU_MSG_FUNCTION_PERF_GET_PSTATE_INFO",
  (NV_VGPU_MSG_FUNCTION_PERF_GET_PERFMON_SAMPLE := 40): "NV_VGPU_MSG_FUNCTION_PERF_GET_PERFMON_SAMPLE",
  (NV_VGPU_MSG_FUNCTION_PERF_GET_VIRTUAL_PSTATE_INFO := 41): "NV_VGPU_MSG_FUNCTION_PERF_GET_VIRTUAL_PSTATE_INFO",
  (NV_VGPU_MSG_FUNCTION_PERF_GET_LEVEL_INFO := 42): "NV_VGPU_MSG_FUNCTION_PERF_GET_LEVEL_INFO",
  (NV_VGPU_MSG_FUNCTION_MAP_SEMA_MEMORY := 43): "NV_VGPU_MSG_FUNCTION_MAP_SEMA_MEMORY",
  (NV_VGPU_MSG_FUNCTION_UNMAP_SEMA_MEMORY := 44): "NV_VGPU_MSG_FUNCTION_UNMAP_SEMA_MEMORY",
  (NV_VGPU_MSG_FUNCTION_SET_SURFACE_PROPERTIES := 45): "NV_VGPU_MSG_FUNCTION_SET_SURFACE_PROPERTIES",
  (NV_VGPU_MSG_FUNCTION_CLEANUP_SURFACE := 46): "NV_VGPU_MSG_FUNCTION_CLEANUP_SURFACE",
  (NV_VGPU_MSG_FUNCTION_UNLOADING_GUEST_DRIVER := 47): "NV_VGPU_MSG_FUNCTION_UNLOADING_GUEST_DRIVER",
  (NV_VGPU_MSG_FUNCTION_TDR_SET_TIMEOUT_STATE := 48): "NV_VGPU_MSG_FUNCTION_TDR_SET_TIMEOUT_STATE",
  (NV_VGPU_MSG_FUNCTION_SWITCH_TO_VGA := 49): "NV_VGPU_MSG_FUNCTION_SWITCH_TO_VGA",
  (NV_VGPU_MSG_FUNCTION_GPU_EXEC_REG_OPS := 50): "NV_VGPU_MSG_FUNCTION_GPU_EXEC_REG_OPS",
  (NV_VGPU_MSG_FUNCTION_GET_STATIC_INFO := 51): "NV_VGPU_MSG_FUNCTION_GET_STATIC_INFO",
  (NV_VGPU_MSG_FUNCTION_ALLOC_VIRTMEM := 52): "NV_VGPU_MSG_FUNCTION_ALLOC_VIRTMEM",
  (NV_VGPU_MSG_FUNCTION_UPDATE_PDE_2 := 53): "NV_VGPU_MSG_FUNCTION_UPDATE_PDE_2",
  (NV_VGPU_MSG_FUNCTION_SET_PAGE_DIRECTORY := 54): "NV_VGPU_MSG_FUNCTION_SET_PAGE_DIRECTORY",
  (NV_VGPU_MSG_FUNCTION_GET_STATIC_PSTATE_INFO := 55): "NV_VGPU_MSG_FUNCTION_GET_STATIC_PSTATE_INFO",
  (NV_VGPU_MSG_FUNCTION_TRANSLATE_GUEST_GPU_PTES := 56): "NV_VGPU_MSG_FUNCTION_TRANSLATE_GUEST_GPU_PTES",
  (NV_VGPU_MSG_FUNCTION_RESERVED_57 := 57): "NV_VGPU_MSG_FUNCTION_RESERVED_57",
  (NV_VGPU_MSG_FUNCTION_RESET_CURRENT_GR_CONTEXT := 58): "NV_VGPU_MSG_FUNCTION_RESET_CURRENT_GR_CONTEXT",
  (NV_VGPU_MSG_FUNCTION_SET_SEMA_MEM_VALIDATION_STATE := 59): "NV_VGPU_MSG_FUNCTION_SET_SEMA_MEM_VALIDATION_STATE",
  (NV_VGPU_MSG_FUNCTION_GET_ENGINE_UTILIZATION := 60): "NV_VGPU_MSG_FUNCTION_GET_ENGINE_UTILIZATION",
  (NV_VGPU_MSG_FUNCTION_UPDATE_GPU_PDES := 61): "NV_VGPU_MSG_FUNCTION_UPDATE_GPU_PDES",
  (NV_VGPU_MSG_FUNCTION_GET_ENCODER_CAPACITY := 62): "NV_VGPU_MSG_FUNCTION_GET_ENCODER_CAPACITY",
  (NV_VGPU_MSG_FUNCTION_VGPU_PF_REG_READ32 := 63): "NV_VGPU_MSG_FUNCTION_VGPU_PF_REG_READ32",
  (NV_VGPU_MSG_FUNCTION_SET_GUEST_SYSTEM_INFO_EXT := 64): "NV_VGPU_MSG_FUNCTION_SET_GUEST_SYSTEM_INFO_EXT",
  ...
  (NV_VGPU_MSG_FUNCTION_RMFS_CLOSE_QUEUE := 67): "NV_VGPU_MSG_FUNCTION_RMFS_CLOSE_QUEUE",
  (NV_VGPU_MSG_FUNCTION_RMFS_CLEANUP := 68): "NV_VGPU_MSG_FUNCTION_RMFS_CLEANUP",
  (NV_VGPU_MSG_FUNCTION_RMFS_TEST := 69): "NV_VGPU_MSG_FUNCTION_RMFS_TEST",
  (NV_VGPU_MSG_FUNCTION_UPDATE_BAR_PDE := 70): "NV_VGPU_MSG_FUNCTION_UPDATE_BAR_PDE",
  (NV_VGPU_MSG_FUNCTION_CONTINUATION_RECORD := 71): "NV_VGPU_MSG_FUNCTION_CONTINUATION_RECORD",
  (NV_VGPU_MSG_FUNCTION_GSP_SET_SYSTEM_INFO := 72): "NV_VGPU_MSG_FUNCTION_GSP_SET_SYSTEM_INFO",
  (NV_VGPU_MSG_FUNCTION_SET_REGISTRY := 73): "NV_VGPU_MSG_FUNCTION_SET_REGISTRY",
  (NV_VGPU_MSG_FUNCTION_GSP_INIT_POST_OBJGPU := 74): "NV_VGPU_MSG_FUNCTION_GSP_INIT_POST_OBJGPU",
  (NV_VGPU_MSG_FUNCTION_SUBDEV_EVENT_SET_NOTIFICATION := 75): "NV_VGPU_MSG_FUNCTION_SUBDEV_EVENT_SET_NOTIFICATION",
  (NV_VGPU_MSG_FUNCTION_GSP_RM_CONTROL := 76): "NV_VGPU_MSG_FUNCTION_GSP_RM_CONTROL",
  (NV_VGPU_MSG_FUNCTION_GET_STATIC_INFO2 := 77): "NV_VGPU_MSG_FUNCTION_GET_STATIC_INFO2",
  (NV_VGPU_MSG_FUNCTION_DUMP_PROTOBUF_COMPONENT := 78): "NV_VGPU_MSG_FUNCTION_DUMP_PROTOBUF_COMPONENT",
  (NV_VGPU_MSG_FUNCTION_UNSET_PAGE_DIRECTORY := 79): "NV_VGPU_MSG_FUNCTION_UNSET_PAGE_DIRECTORY",
  (NV_VGPU_MSG_FUNCTION_GET_CONSOLIDATED_STATIC_INFO := 80): "NV_VGPU_MSG_FUNCTION_GET_CONSOLIDATED_STATIC_INFO",
  (NV_VGPU_MSG_FUNCTION_GMMU_REGISTER_FAULT_BUFFER := 81): "NV_VGPU_MSG_FUNCTION_GMMU_REGISTER_FAULT_BUFFER",
  (NV_VGPU_MSG_FUNCTION_GMMU_UNREGISTER_FAULT_BUFFER := 82): "NV_VGPU_MSG_FUNCTION_GMMU_UNREGISTER_FAULT_BUFFER",
  ...
  (NV_VGPU_MSG_FUNCTION_GMMU_UNREGISTER_CLIENT_SHADOW_FAULT_BUFFER := 84): "NV_VGPU_MSG_FUNCTION_GMMU_UNREGISTER_CLIENT_SHADOW_FAULT_BUFFER",
  (NV_VGPU_MSG_FUNCTION_CTRL_SET_VGPU_FB_USAGE := 85): "NV_VGPU_MSG_FUNCTION_CTRL_SET_VGPU_FB_USAGE",
  (NV_VGPU_MSG_FUNCTION_CTRL_NVFBC_SW_SESSION_UPDATE_INFO := 86): "NV_VGPU_MSG_FUNCTION_CTRL_NVFBC_SW_SESSION_UPDATE_INFO",
  (NV_VGPU_MSG_FUNCTION_CTRL_NVENC_SW_SESSION_UPDATE_INFO := 87): "NV_VGPU_MSG_FUNCTION_CTRL_NVENC_SW_SESSION_UPDATE_INFO",
  (NV_VGPU_MSG_FUNCTION_CTRL_RESET_CHANNEL := 88): "NV_VGPU_MSG_FUNCTION_CTRL_RESET_CHANNEL",
  (NV_VGPU_MSG_FUNCTION_CTRL_RESET_ISOLATED_CHANNEL := 89): "NV_VGPU_MSG_FUNCTION_CTRL_RESET_ISOLATED_CHANNEL",
  (NV_VGPU_MSG_FUNCTION_CTRL_GPU_HANDLE_VF_PRI_FAULT := 90): "NV_VGPU_MSG_FUNCTION_CTRL_GPU_HANDLE_VF_PRI_FAULT",
  (NV_VGPU_MSG_FUNCTION_CTRL_CLK_GET_EXTENDED_INFO := 91): "NV_VGPU_MSG_FUNCTION_CTRL_CLK_GET_EXTENDED_INFO",
  (NV_VGPU_MSG_FUNCTION_CTRL_PERF_BOOST := 92): "NV_VGPU_MSG_FUNCTION_CTRL_PERF_BOOST",
  (NV_VGPU_MSG_FUNCTION_CTRL_PERF_VPSTATES_GET_CONTROL := 93): "NV_VGPU_MSG_FUNCTION_CTRL_PERF_VPSTATES_GET_CONTROL",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_ZBC_CLEAR_TABLE := 94): "NV_VGPU_MSG_FUNCTION_CTRL_GET_ZBC_CLEAR_TABLE",
  (NV_VGPU_MSG_FUNCTION_CTRL_SET_ZBC_COLOR_CLEAR := 95): "NV_VGPU_MSG_FUNCTION_CTRL_SET_ZBC_COLOR_CLEAR",
  (NV_VGPU_MSG_FUNCTION_CTRL_SET_ZBC_DEPTH_CLEAR := 96): "NV_VGPU_MSG_FUNCTION_CTRL_SET_ZBC_DEPTH_CLEAR",
  (NV_VGPU_MSG_FUNCTION_CTRL_GPFIFO_SCHEDULE := 97): "NV_VGPU_MSG_FUNCTION_CTRL_GPFIFO_SCHEDULE",
  (NV_VGPU_MSG_FUNCTION_CTRL_SET_TIMESLICE := 98): "NV_VGPU_MSG_FUNCTION_CTRL_SET_TIMESLICE",
  (NV_VGPU_MSG_FUNCTION_CTRL_PREEMPT := 99): "NV_VGPU_MSG_FUNCTION_CTRL_PREEMPT",
  (NV_VGPU_MSG_FUNCTION_CTRL_FIFO_DISABLE_CHANNELS := 100): "NV_VGPU_MSG_FUNCTION_CTRL_FIFO_DISABLE_CHANNELS",
  (NV_VGPU_MSG_FUNCTION_CTRL_SET_TSG_INTERLEAVE_LEVEL := 101): "NV_VGPU_MSG_FUNCTION_CTRL_SET_TSG_INTERLEAVE_LEVEL",
  (NV_VGPU_MSG_FUNCTION_CTRL_SET_CHANNEL_INTERLEAVE_LEVEL := 102): "NV_VGPU_MSG_FUNCTION_CTRL_SET_CHANNEL_INTERLEAVE_LEVEL",
  (NV_VGPU_MSG_FUNCTION_GSP_RM_ALLOC := 103): "NV_VGPU_MSG_FUNCTION_GSP_RM_ALLOC",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_P2P_CAPS_V2 := 104): "NV_VGPU_MSG_FUNCTION_CTRL_GET_P2P_CAPS_V2",
  (NV_VGPU_MSG_FUNCTION_CTRL_CIPHER_AES_ENCRYPT := 105): "NV_VGPU_MSG_FUNCTION_CTRL_CIPHER_AES_ENCRYPT",
  (NV_VGPU_MSG_FUNCTION_CTRL_CIPHER_SESSION_KEY := 106): "NV_VGPU_MSG_FUNCTION_CTRL_CIPHER_SESSION_KEY",
  (NV_VGPU_MSG_FUNCTION_CTRL_CIPHER_SESSION_KEY_STATUS := 107): "NV_VGPU_MSG_FUNCTION_CTRL_CIPHER_SESSION_KEY_STATUS",
  ...
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_EXCEPTION_MASK := 110): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_EXCEPTION_MASK",
  (NV_VGPU_MSG_FUNCTION_CTRL_GPU_PROMOTE_CTX := 111): "NV_VGPU_MSG_FUNCTION_CTRL_GPU_PROMOTE_CTX",
  (NV_VGPU_MSG_FUNCTION_CTRL_GR_CTXSW_PREEMPTION_BIND := 112): "NV_VGPU_MSG_FUNCTION_CTRL_GR_CTXSW_PREEMPTION_BIND",
  (NV_VGPU_MSG_FUNCTION_CTRL_GR_SET_CTXSW_PREEMPTION_MODE := 113): "NV_VGPU_MSG_FUNCTION_CTRL_GR_SET_CTXSW_PREEMPTION_MODE",
  (NV_VGPU_MSG_FUNCTION_CTRL_GR_CTXSW_ZCULL_BIND := 114): "NV_VGPU_MSG_FUNCTION_CTRL_GR_CTXSW_ZCULL_BIND",
  (NV_VGPU_MSG_FUNCTION_CTRL_GPU_INITIALIZE_CTX := 115): "NV_VGPU_MSG_FUNCTION_CTRL_GPU_INITIALIZE_CTX",
  (NV_VGPU_MSG_FUNCTION_CTRL_VASPACE_COPY_SERVER_RESERVED_PDES := 116): "NV_VGPU_MSG_FUNCTION_CTRL_VASPACE_COPY_SERVER_RESERVED_PDES",
  (NV_VGPU_MSG_FUNCTION_CTRL_FIFO_CLEAR_FAULTED_BIT := 117): "NV_VGPU_MSG_FUNCTION_CTRL_FIFO_CLEAR_FAULTED_BIT",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_LATEST_ECC_ADDRESSES := 118): "NV_VGPU_MSG_FUNCTION_CTRL_GET_LATEST_ECC_ADDRESSES",
  (NV_VGPU_MSG_FUNCTION_CTRL_MC_SERVICE_INTERRUPTS := 119): "NV_VGPU_MSG_FUNCTION_CTRL_MC_SERVICE_INTERRUPTS",
  (NV_VGPU_MSG_FUNCTION_CTRL_DMA_SET_DEFAULT_VASPACE := 120): "NV_VGPU_MSG_FUNCTION_CTRL_DMA_SET_DEFAULT_VASPACE",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_CE_PCE_MASK := 121): "NV_VGPU_MSG_FUNCTION_CTRL_GET_CE_PCE_MASK",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_ZBC_CLEAR_TABLE_ENTRY := 122): "NV_VGPU_MSG_FUNCTION_CTRL_GET_ZBC_CLEAR_TABLE_ENTRY",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_NVLINK_PEER_ID_MASK := 123): "NV_VGPU_MSG_FUNCTION_CTRL_GET_NVLINK_PEER_ID_MASK",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_NVLINK_STATUS := 124): "NV_VGPU_MSG_FUNCTION_CTRL_GET_NVLINK_STATUS",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_P2P_CAPS := 125): "NV_VGPU_MSG_FUNCTION_CTRL_GET_P2P_CAPS",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_P2P_CAPS_MATRIX := 126): "NV_VGPU_MSG_FUNCTION_CTRL_GET_P2P_CAPS_MATRIX",
  (NV_VGPU_MSG_FUNCTION_RESERVED_0 := 127): "NV_VGPU_MSG_FUNCTION_RESERVED_0",
  (NV_VGPU_MSG_FUNCTION_CTRL_RESERVE_PM_AREA_SMPC := 128): "NV_VGPU_MSG_FUNCTION_CTRL_RESERVE_PM_AREA_SMPC",
  (NV_VGPU_MSG_FUNCTION_CTRL_RESERVE_HWPM_LEGACY := 129): "NV_VGPU_MSG_FUNCTION_CTRL_RESERVE_HWPM_LEGACY",
  (NV_VGPU_MSG_FUNCTION_CTRL_B0CC_EXEC_REG_OPS := 130): "NV_VGPU_MSG_FUNCTION_CTRL_B0CC_EXEC_REG_OPS",
  (NV_VGPU_MSG_FUNCTION_CTRL_BIND_PM_RESOURCES := 131): "NV_VGPU_MSG_FUNCTION_CTRL_BIND_PM_RESOURCES",
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_SUSPEND_CONTEXT := 132): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_SUSPEND_CONTEXT",
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_RESUME_CONTEXT := 133): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_RESUME_CONTEXT",
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_EXEC_REG_OPS := 134): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_EXEC_REG_OPS",
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_MODE_MMU_DEBUG := 135): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_MODE_MMU_DEBUG",
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_READ_SINGLE_SM_ERROR_STATE := 136): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_READ_SINGLE_SM_ERROR_STATE",
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_CLEAR_SINGLE_SM_ERROR_STATE := 137): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_CLEAR_SINGLE_SM_ERROR_STATE",
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_MODE_ERRBAR_DEBUG := 138): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_MODE_ERRBAR_DEBUG",
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_NEXT_STOP_TRIGGER_TYPE := 139): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_NEXT_STOP_TRIGGER_TYPE",
  (NV_VGPU_MSG_FUNCTION_CTRL_ALLOC_PMA_STREAM := 140): "NV_VGPU_MSG_FUNCTION_CTRL_ALLOC_PMA_STREAM",
  (NV_VGPU_MSG_FUNCTION_CTRL_PMA_STREAM_UPDATE_GET_PUT := 141): "NV_VGPU_MSG_FUNCTION_CTRL_PMA_STREAM_UPDATE_GET_PUT",
  (NV_VGPU_MSG_FUNCTION_CTRL_FB_GET_INFO_V2 := 142): "NV_VGPU_MSG_FUNCTION_CTRL_FB_GET_INFO_V2",
  (NV_VGPU_MSG_FUNCTION_CTRL_FIFO_SET_CHANNEL_PROPERTIES := 143): "NV_VGPU_MSG_FUNCTION_CTRL_FIFO_SET_CHANNEL_PROPERTIES",
  (NV_VGPU_MSG_FUNCTION_CTRL_GR_GET_CTX_BUFFER_INFO := 144): "NV_VGPU_MSG_FUNCTION_CTRL_GR_GET_CTX_BUFFER_INFO",
  (NV_VGPU_MSG_FUNCTION_CTRL_KGR_GET_CTX_BUFFER_PTES := 145): "NV_VGPU_MSG_FUNCTION_CTRL_KGR_GET_CTX_BUFFER_PTES",
  (NV_VGPU_MSG_FUNCTION_CTRL_GPU_EVICT_CTX := 146): "NV_VGPU_MSG_FUNCTION_CTRL_GPU_EVICT_CTX",
  (NV_VGPU_MSG_FUNCTION_CTRL_FB_GET_FS_INFO := 147): "NV_VGPU_MSG_FUNCTION_CTRL_FB_GET_FS_INFO",
  (NV_VGPU_MSG_FUNCTION_CTRL_GRMGR_GET_GR_FS_INFO := 148): "NV_VGPU_MSG_FUNCTION_CTRL_GRMGR_GET_GR_FS_INFO",
  (NV_VGPU_MSG_FUNCTION_CTRL_STOP_CHANNEL := 149): "NV_VGPU_MSG_FUNCTION_CTRL_STOP_CHANNEL",
  (NV_VGPU_MSG_FUNCTION_CTRL_GR_PC_SAMPLING_MODE := 150): "NV_VGPU_MSG_FUNCTION_CTRL_GR_PC_SAMPLING_MODE",
  (NV_VGPU_MSG_FUNCTION_CTRL_PERF_RATED_TDP_GET_STATUS := 151): "NV_VGPU_MSG_FUNCTION_CTRL_PERF_RATED_TDP_GET_STATUS",
  (NV_VGPU_MSG_FUNCTION_CTRL_PERF_RATED_TDP_SET_CONTROL := 152): "NV_VGPU_MSG_FUNCTION_CTRL_PERF_RATED_TDP_SET_CONTROL",
  (NV_VGPU_MSG_FUNCTION_CTRL_FREE_PMA_STREAM := 153): "NV_VGPU_MSG_FUNCTION_CTRL_FREE_PMA_STREAM",
  (NV_VGPU_MSG_FUNCTION_CTRL_TIMER_SET_GR_TICK_FREQ := 154): "NV_VGPU_MSG_FUNCTION_CTRL_TIMER_SET_GR_TICK_FREQ",
  (NV_VGPU_MSG_FUNCTION_CTRL_FIFO_SETUP_VF_ZOMBIE_SUBCTX_PDB := 155): "NV_VGPU_MSG_FUNCTION_CTRL_FIFO_SETUP_VF_ZOMBIE_SUBCTX_PDB",
  (NV_VGPU_MSG_FUNCTION_GET_CONSOLIDATED_GR_STATIC_INFO := 156): "NV_VGPU_MSG_FUNCTION_GET_CONSOLIDATED_GR_STATIC_INFO",
  (NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_SINGLE_SM_SINGLE_STEP := 157): "NV_VGPU_MSG_FUNCTION_CTRL_DBG_SET_SINGLE_SM_SINGLE_STEP",
  (NV_VGPU_MSG_FUNCTION_CTRL_GR_GET_TPC_PARTITION_MODE := 158): "NV_VGPU_MSG_FUNCTION_CTRL_GR_GET_TPC_PARTITION_MODE",
  (NV_VGPU_MSG_FUNCTION_CTRL_GR_SET_TPC_PARTITION_MODE := 159): "NV_VGPU_MSG_FUNCTION_CTRL_GR_SET_TPC_PARTITION_MODE",
  (NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_ALLOCATE := 160): "NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_ALLOCATE",
  (NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_DESTROY := 161): "NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_DESTROY",
  (NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_MAP := 162): "NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_MAP",
  (NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_UNMAP := 163): "NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_UNMAP",
  (NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_PUSH_STREAM := 164): "NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_PUSH_STREAM",
  (NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_SET_HANDLES := 165): "NV_VGPU_MSG_FUNCTION_UVM_PAGING_CHANNEL_SET_HANDLES",
  (NV_VGPU_MSG_FUNCTION_UVM_METHOD_STREAM_GUEST_PAGES_OPERATION := 166): "NV_VGPU_MSG_FUNCTION_UVM_METHOD_STREAM_GUEST_PAGES_OPERATION",
  (NV_VGPU_MSG_FUNCTION_CTRL_INTERNAL_QUIESCE_PMA_CHANNEL := 167): "NV_VGPU_MSG_FUNCTION_CTRL_INTERNAL_QUIESCE_PMA_CHANNEL",
  (NV_VGPU_MSG_FUNCTION_DCE_RM_INIT := 168): "NV_VGPU_MSG_FUNCTION_DCE_RM_INIT",
  (NV_VGPU_MSG_FUNCTION_REGISTER_VIRTUAL_EVENT_BUFFER := 169): "NV_VGPU_MSG_FUNCTION_REGISTER_VIRTUAL_EVENT_BUFFER",
  (NV_VGPU_MSG_FUNCTION_CTRL_EVENT_BUFFER_UPDATE_GET := 170): "NV_VGPU_MSG_FUNCTION_CTRL_EVENT_BUFFER_UPDATE_GET",
  (NV_VGPU_MSG_FUNCTION_GET_PLCABLE_ADDRESS_KIND := 171): "NV_VGPU_MSG_FUNCTION_GET_PLCABLE_ADDRESS_KIND",
  (NV_VGPU_MSG_FUNCTION_CTRL_PERF_LIMITS_SET_STATUS_V2 := 172): "NV_VGPU_MSG_FUNCTION_CTRL_PERF_LIMITS_SET_STATUS_V2",
  (NV_VGPU_MSG_FUNCTION_CTRL_INTERNAL_SRIOV_PROMOTE_PMA_STREAM := 173): "NV_VGPU_MSG_FUNCTION_CTRL_INTERNAL_SRIOV_PROMOTE_PMA_STREAM",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_MMU_DEBUG_MODE := 174): "NV_VGPU_MSG_FUNCTION_CTRL_GET_MMU_DEBUG_MODE",
  (NV_VGPU_MSG_FUNCTION_CTRL_INTERNAL_PROMOTE_FAULT_METHOD_BUFFERS := 175): "NV_VGPU_MSG_FUNCTION_CTRL_INTERNAL_PROMOTE_FAULT_METHOD_BUFFERS",
  (NV_VGPU_MSG_FUNCTION_CTRL_FLCN_GET_CTX_BUFFER_SIZE := 176): "NV_VGPU_MSG_FUNCTION_CTRL_FLCN_GET_CTX_BUFFER_SIZE",
  (NV_VGPU_MSG_FUNCTION_CTRL_FLCN_GET_CTX_BUFFER_INFO := 177): "NV_VGPU_MSG_FUNCTION_CTRL_FLCN_GET_CTX_BUFFER_INFO",
  (NV_VGPU_MSG_FUNCTION_DISABLE_CHANNELS := 178): "NV_VGPU_MSG_FUNCTION_DISABLE_CHANNELS",
  (NV_VGPU_MSG_FUNCTION_CTRL_FABRIC_MEMORY_DESCRIBE := 179): "NV_VGPU_MSG_FUNCTION_CTRL_FABRIC_MEMORY_DESCRIBE",
  (NV_VGPU_MSG_FUNCTION_CTRL_FABRIC_MEM_STATS := 180): "NV_VGPU_MSG_FUNCTION_CTRL_FABRIC_MEM_STATS",
  (NV_VGPU_MSG_FUNCTION_SAVE_HIBERNATION_DATA := 181): "NV_VGPU_MSG_FUNCTION_SAVE_HIBERNATION_DATA",
  (NV_VGPU_MSG_FUNCTION_RESTORE_HIBERNATION_DATA := 182): "NV_VGPU_MSG_FUNCTION_RESTORE_HIBERNATION_DATA",
  (NV_VGPU_MSG_FUNCTION_CTRL_INTERNAL_MEMSYS_SET_ZBC_REFERENCED := 183): "NV_VGPU_MSG_FUNCTION_CTRL_INTERNAL_MEMSYS_SET_ZBC_REFERENCED",
  (NV_VGPU_MSG_FUNCTION_CTRL_EXEC_PARTITIONS_CREATE := 184): "NV_VGPU_MSG_FUNCTION_CTRL_EXEC_PARTITIONS_CREATE",
  ...
  (NV_VGPU_MSG_FUNCTION_CTRL_GPFIFO_SET_WORK_SUBMIT_TOKEN_NOTIF_INDEX := 187): "NV_VGPU_MSG_FUNCTION_CTRL_GPFIFO_SET_WORK_SUBMIT_TOKEN_NOTIF_INDEX",
  (
  ...
  (NV_VGPU_MSG_FUNCTION_CTRL_BUS_SET_P2P_MAPPING := 192): "NV_VGPU_MSG_FUNCTION_CTRL_BUS_SET_P2P_MAPPING",
  (NV_VGPU_MSG_FUNCTION_CTRL_BUS_UNSET_P2P_MAPPING := 193): "NV_VGPU_MSG_FUNCTION_CTRL_BUS_UNSET_P2P_MAPPING",
  ...
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_TOTAL_HS_CREDITS := 196): "NV_VGPU_MSG_FUNCTION_CTRL_GET_TOTAL_HS_CREDITS",
  (NV_VGPU_MSG_FUNCTION_CTRL_GET_HS_CREDITS := 197): "NV_VGPU_MSG_FUNCTION_CTRL_GET_HS_CREDITS",
  (NV_VGPU_MSG_FUNCTION_CTRL_SET_HS_CREDITS := 198): "NV_VGPU_MSG_FUNCTION_CTRL_SET_HS_CREDITS",
  (NV_VGPU_MSG_FUNCTION_CTRL_PM_AREA_PC_SAMPLER := 199): "NV_VGPU_MSG_FUNCTION_CTRL_PM_AREA_PC_SAMPLER",
  (NV_VGPU_MSG_FUNCTION_INVALIDATE_TLB := 200): "NV_VGPU_MSG_FUNCTION_INVALIDATE_TLB",
  (NV_VGPU_MSG_FUNCTION_CTRL_GPU_QUERY_ECC_STATUS := 201): "NV_VGPU_MSG_FUNCTION_CTRL_GPU_QUERY_ECC_STATUS",
  (NV_VGPU_MSG_FUNCTION_ECC_NOTIFIER_WRITE_ACK := 202): "NV_VGPU_MSG_FUNCTION_ECC_NOTIFIER_WRITE_ACK",
  ...
  (NV_VGPU_MSG_FUNCTION_CTRL_CMD_INTERNAL_GPU_START_FABRIC_PROBE := 205): "NV_VGPU_MSG_FUNCTION_CTRL_CMD_INTERNAL_GPU_START_FABRIC_PROBE",
  (NV_VGPU_MSG_FUNCTION_CTRL_NVLINK_GET_INBAND_RECEIVED_DATA := 206): "NV_VGPU_MSG_FUNCTION_CTRL_NVLINK_GET_INBAND_RECEIVED_DATA",
  (NV_VGPU_MSG_FUNCTION_GET_STATIC_DATA := 207): "NV_VGPU_MSG_FUNCTION_GET_STATIC_DATA",
  (NV_VGPU_MSG_FUNCTION_RESERVED_208 := 208): "NV_VGPU_MSG_FUNCTION_RESERVED_208",
  (NV_VGPU_MSG_FUNCTION_CTRL_GPU_GET_INFO_V2 := 209): "NV_VGPU_MSG_FUNCTION_CTRL_GPU_GET_INFO_V2",
  (NV_VGPU_MSG_FUNCTION_GET_BRAND_CAPS := 210): "NV_VGPU_MSG_FUNCTION_GET_BRAND_CAPS",
  (NV_VGPU_MSG_FUNCTION_CTRL_CMD_NVLINK_INBAND_SEND_DATA := 211): "NV_VGPU_MSG_FUNCTION_CTRL_CMD_NVLINK_INBAND_SEND_DATA",
  (NV_VGPU_MSG_FUNCTION_UPDATE_GPM_GUEST_BUFFER_INFO := 212): "NV_VGPU_MSG_FUNCTION_UPDATE_GPM_GUEST_BUFFER_INFO",
  (NV_VGPU_MSG_FUNCTION_CTRL_CMD_INTERNAL_CONTROL_GSP_TRACE := 213): "NV_VGPU_MSG_FUNCTION_CTRL_CMD_INTERNAL_CONTROL_GSP_TRACE",
  (NV_VGPU_MSG_FUNCTION_CTRL_SET_ZBC_STENCIL_CLEAR := 214): "NV_VGPU_MSG_FUNCTION_CTRL_SET_ZBC_STENCIL_CLEAR",
  (NV_VGPU_MSG_FUNCTION_CTRL_SUBDEVICE_GET_VGPU_HEAP_STATS := 215): "NV_VGPU_MSG_FUNCTION_CTRL_SUBDEVICE_GET_VGPU_HEAP_STATS",
  (NV_VGPU_MSG_FUNCTION_CTRL_SUBDEVICE_GET_LIBOS_HEAP_STATS := 216): "NV_VGPU_MSG_FUNCTION_CTRL_SUBDEVICE_GET_LIBOS_HEAP_STATS",
  ...
  (NV_VGPU_MSG_FUNCTION_CTRL_RESERVE_CCU_PROF := 221): "NV_VGPU_MSG_FUNCTION_CTRL_RESERVE_CCU_PROF",
  (NV_VGPU_MSG_FUNCTION_CTRL_RELEASE_CCU_PROF := 222): "NV_VGPU_MSG_FUNCTION_CTRL_RELEASE_CCU_PROF",
  (NV_VGPU_MSG_FUNCTION_NUM_FUNCTIONS := 223): "NV_VGPU_MSG_FUNCTION_NUM_FUNCTIONS",
}
rpc_events: dict[int, str] = {
  (NV_VGPU_MSG_EVENT_FIRST_EVENT := 4096): "NV_VGPU_MSG_EVENT_FIRST_EVENT",
  (NV_VGPU_MSG_EVENT_GSP_INIT_DONE := 4097): "NV_VGPU_MSG_EVENT_GSP_INIT_DONE",
  (NV_VGPU_MSG_EVENT_GSP_RUN_CPU_SEQUENCER := 4098): "NV_VGPU_MSG_EVENT_GSP_RUN_CPU_SEQUENCER",
  (NV_VGPU_MSG_EVENT_POST_EVENT := 4099): "NV_VGPU_MSG_EVENT_POST_EVENT",
  (NV_VGPU_MSG_EVENT_RC_TRIGGERED := 4100): "NV_VGPU_MSG_EVENT_RC_TRIGGERED",
  (NV_VGPU_MSG_EVENT_MMU_FAULT_QUEUED := 4101): "NV_VGPU_MSG_EVENT_MMU_FAULT_QUEUED",
  (NV_VGPU_MSG_EVENT_OS_ERROR_LOG := 4102): "NV_VGPU_MSG_EVENT_OS_ERROR_LOG",
  (NV_VGPU_MSG_EVENT_RG_LINE_INTR := 4103): "NV_VGPU_MSG_EVENT_RG_LINE_INTR",
  (NV_VGPU_MSG_EVENT_GPUACCT_PERFMON_UTIL_SAMPLES := 4104): "NV_VGPU_MSG_EVENT_GPUACCT_PERFMON_UTIL_SAMPLES",
  (NV_VGPU_MSG_EVENT_SIM_READ := 4105): "NV_VGPU_MSG_EVENT_SIM_READ",
  (NV_VGPU_MSG_EVENT_SIM_WRITE := 4106): "NV_VGPU_MSG_EVENT_SIM_WRITE",
  (NV_VGPU_MSG_EVENT_SEMAPHORE_SCHEDULE_CALLBACK := 4107): "NV_VGPU_MSG_EVENT_SEMAPHORE_SCHEDULE_CALLBACK",
  (NV_VGPU_MSG_EVENT_UCODE_LIBOS_PRINT := 4108): "NV_VGPU_MSG_EVENT_UCODE_LIBOS_PRINT",
  (NV_VGPU_MSG_EVENT_VGPU_GSP_PLUGIN_TRIGGERED := 4109): "NV_VGPU_MSG_EVENT_VGPU_GSP_PLUGIN_TRIGGERED",
  (NV_VGPU_MSG_EVENT_PERF_GPU_BOOST_SYNC_LIMITS_CALLBACK := 4110): "NV_VGPU_MSG_EVENT_PERF_GPU_BOOST_SYNC_LIMITS_CALLBACK",
  (NV_VGPU_MSG_EVENT_PERF_BRIDGELESS_INFO_UPDATE := 4111): "NV_VGPU_MSG_EVENT_PERF_BRIDGELESS_INFO_UPDATE",
  (NV_VGPU_MSG_EVENT_VGPU_CONFIG := 4112): "NV_VGPU_MSG_EVENT_VGPU_CONFIG",
  (NV_VGPU_MSG_EVENT_DISPLAY_MODESET := 4113): "NV_VGPU_MSG_EVENT_DISPLAY_MODESET",
  (NV_VGPU_MSG_EVENT_EXTDEV_INTR_SERVICE := 4114): "NV_VGPU_MSG_EVENT_EXTDEV_INTR_SERVICE",
  (NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_256 := 4115): "NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_256",
  (NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_512 := 4116): "NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_512",
  (NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_1024 := 4117): "NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_1024",
  (NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_2048 := 4118): "NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_2048",
  (NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_4096 := 4119): "NV_VGPU_MSG_EVENT_NVLINK_INBAND_RECEIVED_DATA_4096",
  (NV_VGPU_MSG_EVENT_TIMED_SEMAPHORE_RELEASE := 4120): "NV_VGPU_MSG_EVENT_TIMED_SEMAPHORE_RELEASE",
  (NV_VGPU_MSG_EVENT_NVLINK_IS_GPU_DEGRADED := 4121): "NV_VGPU_MSG_EVENT_NVLINK_IS_GPU_DEGRADED",
  (NV_VGPU_MSG_EVENT_PFM_REQ_HNDLR_STATE_SYNC_CALLBACK := 4122): "NV_VGPU_MSG_EVENT_PFM_REQ_HNDLR_STATE_SYNC_CALLBACK",
  (NV_VGPU_MSG_EVENT_NVLINK_FAULT_UP := 4123): "NV_VGPU_MSG_EVENT_NVLINK_FAULT_UP",
  (NV_VGPU_MSG_EVENT_GSP_LOCKDOWN_NOTICE := 4124): "NV_VGPU_MSG_EVENT_GSP_LOCKDOWN_NOTICE",
  (NV_VGPU_MSG_EVENT_MIG_CI_CONFIG_UPDATE := 4125): "NV_VGPU_MSG_EVENT_MIG_CI_CONFIG_UPDATE",
  (NV_VGPU_MSG_EVENT_UPDATE_GSP_TRACE := 4126): "NV_VGPU_MSG_EVENT_UPDATE_GSP_TRACE",
  (NV_VGPU_MSG_EVENT_NVLINK_FATAL_ERROR_RECOVERY := 4127): "NV_VGPU_MSG_EVENT_NVLINK_FATAL_ERROR_RECOVERY",
  (NV_VGPU_MSG_EVENT_GSP_POST_NOCAT_RECORD := 4128): "NV_VGPU_MSG_EVENT_GSP_POST_NOCAT_RECORD",
  (NV_VGPU_MSG_EVENT_FECS_ERROR := 4129): "NV_VGPU_MSG_EVENT_FECS_ERROR",
  (NV_VGPU_MSG_EVENT_RECOVERY_ACTION := 4130): "NV_VGPU_MSG_EVENT_RECOVERY_ACTION",
  (NV_VGPU_MSG_EVENT_NUM_EVENTS := 4131): "NV_VGPU_MSG_EVENT_NUM_EVENTS",
}
LibosAddress: TypeAlias = ctypes.c_uint64
LibosMemoryRegionKind: dict[int, str] = {
  (LIBOS_MEMORY_REGION_NONE := 0): "LIBOS_MEMORY_REGION_NONE",
  (LIBOS_MEMORY_REGION_CONTIGUOUS := 1): "LIBOS_MEMORY_REGION_CONTIGUOUS",
  (LIBOS_MEMORY_REGION_RADIX3 := 2): "LIBOS_MEMORY_REGION_RADIX3",
}
LibosMemoryRegionLoc: dict[int, str] = {
  (LIBOS_MEMORY_REGION_LOC_NONE := 0): "LIBOS_MEMORY_REGION_LOC_NONE",
  (LIBOS_MEMORY_REGION_LOC_SYSMEM := 1): "LIBOS_MEMORY_REGION_LOC_SYSMEM",
  (LIBOS_MEMORY_REGION_LOC_FB := 2): "LIBOS_MEMORY_REGION_LOC_FB",
}
...
LibosMemoryRegionInitArgument.register_fields([
  ("id8", LibosAddress, 0),
  ("pa", LibosAddress, 8),
  ("size", LibosAddress, 16),
  ("kind", NvU8, 24),
  ("loc", NvU8, 25),
])
...
volatile_msgqTxHeader.register_fields([
  ("version", NvU32, 0),
  ("size", NvU32, 4),
  ("msgSize", NvU32, 8),
  ("msgCount", NvU32, 12),
...
msgqMetadata.register_fields([
  ("pOurTxHdr", c.POINTER[msgqTxHeader], 0),
  ("pTheirTxHdr", c.POINTER[msgqTxHeader], 8),
  ("pOurRxHdr", c.POINTER[msgqRxHeader], 16),
  ("pTheirRxHdr", c.POINTER[msgqRxHeader], 24),
  ("pOurEntries", c.POINTER[NvU8], 32),
  ("pTheirEntries", c.POINTER[NvU8], 40),
  ("pReadIncoming", c.POINTER[NvU32], 48),
  ("pWriteIncoming", c.POINTER[NvU32], 56),
  ("pReadOutgoing", c.POINTER[NvU32], 64),
  ("pWriteOutgoing", c.POINTER[NvU32], 72),
  ("tx", msgqTxHeader, 80),
  ("txReadPtr", NvU32, 112),
  ("txFree", NvU32, 116),
  ("txLinked", NvBool, 120),
  ...
  ("rxAvail", NvU32, 160),
  ("rxLinked", NvBool, 164),
  ("rxSwapped", NvBool, 165),
  ("fcnNotify", msgqFcnNotifyRemote, 168),
  ("fcnNotifyArg", ctypes.c_void_p, 176),
  ("fcnBackendRw", msgqFcnBackendRw, 184),
  ("fcnBackendRwArg", ctypes.c_void_p, 192),
  ("fcnInvalidate", msgqFcnCacheOp, 200),
  ("fcnFlush", msgqFcnCacheOp, 208),
  ("fcnZero", msgqFcnCacheOp, 216),
  ("fcnBarrier", msgqFcnBarrier, 224),
])
...
struct_rpc_set_guest_system_info_v03_00.register_fields([
  ("vgxVersionMajorNum", NvU32, 0),
  ("vgxVersionMinorNum", NvU32, 4),
  ("guestDriverVersionBufferLength", NvU32, 8),
  ("guestVersionBufferLength", NvU32, 12),
  ("guestTitleBufferLength", NvU32, 16),
  ("guestClNum", NvU32, 20),
  ("guestDriverVersion", c.Array[ctypes.c_char, Literal[256]], 24),
  ("guestVersion", c.Array[ctypes.c_char, Literal[256]], 280),
  ("guestTitle", c.Array[ctypes.c_char, Literal[256]], 536),
])
...
struct_rpc_set_guest_system_info_ext_v15_02.register_fields([
  ("guestDriverBranch", c.Array[ctypes.c_char, Literal[256]], 0),
  ("domain", NvU32, 256),
  ("bus", NvU16, 260),
  ("device", NvU16, 262),
])
...
struct_rpc_set_guest_system_info_ext_v25_1B.register_fields([
  ("guestDriverBranch", c.Array[ctypes.c_char, Literal[256]], 0),
  ("domain", NvU32, 256),
  ("bus", NvU16, 260),
  ("device", NvU16, 262),
  ("gridBuildCsp", NvU32, 264),
])
...
struct_rpc_alloc_root_v07_00.register_fields([
  ("hClient", NvHandle, 0),
  ("processID", NvU32, 4),
  ("processName", c.Array[ctypes.c_char, Literal[100]], 8),
])
...
struct_pte_desc.register_fields([
  ("idr", NvU32, 0, 2, 0),
  ("reserved1", NvU32, 0, 14, 2),
  ("length", NvU32, 2, 16, 0),
  ("pte_pde", c.Array[struct_pte_desc_pte_pde, Literal[0]], 8),
])
struct_rpc_alloc_memory_v13_01.register_fields([
  ("hClient", NvHandle, 0),
  ("hDevice", NvHandle, 4),
  ("hMemory", NvHandle, 8),
  ("hClass", NvU32, 12),
...
struct_NV_CHANNEL_ALLOC_PARAMS_v1F_04.register_fields([
  ("hObjectError", NvHandle, 0),
  ("hObjectBuffer", NvHandle, 4),
  ("gpFifoOffset", NvU64, 8),
  ("gpFifoEntries", NvU32, 16),
  ("flags", NvU32, 20),
  ("hContextShare", NvHandle, 24),
  ("hVASpace", NvHandle, 28),
  ("hUserdMemory", c.Array[NvHandle, Literal[1]], 32),
  ("userdOffset", c.Array[NvU64, Literal[1]], 40),
  ("engineType", NvU32, 48),
  ("hObjectEccError", NvHandle, 52),
  ("instanceMem", NV_MEMORY_DESC_PARAMS_v18_01, 56),
  ("ramfcMem", NV_MEMORY_DESC_PARAMS_v18_01, 80),
  ("userdMem", NV_MEMORY_DESC_PARAMS_v18_01, 104),
  ("mthdbufMem", NV_MEMORY_DESC_PARAMS_v18_01, 128),
  ("hPhysChannelGroup", NvHandle, 152),
  ("subDeviceId", NvHandle, 156),
  ("internalFlags", NvU32, 160),
  ("errorNotifierMem", NV_MEMORY_DESC_PARAMS_v18_01, 168),
  ("eccErrorNotifierMem", NV_MEMORY_DESC_PARAMS_v18_01, 192),
])
struct_rpc_alloc_channel_dma_v1F_04.register_fields([
  ("hClient", NvHandle, 0),
  ("hDevice", NvHandle, 4),
  ("hChannel", NvHandle, 8),
  ("hClass", NvU32, 12),
  ("flags", NvU32, 16),
  ("params", NV_CHANNEL_ALLOC_PARAMS_v1F_04, 24),
  ("chid", NvU32, 240),
])
...
struct_alloc_object_GF100_DISP_SW_v03_00.register_fields([
  ("_reserved1", NvU32, 0),
  ("_reserved2", NvU64, 8),
  ("logicalHeadId", NvU32, 16),
  ("displayMask", NvU32, 20),
  ("caps", NvU32, 24),
])
...
struct_alloc_object_NVD0B7_VIDEO_ENCODER_v03_00.register_fields([
  ("size", NvU32, 0),
  ("prohibitMultipleInstances", NvU32, 4),
  ("engineInstance", NvU32, 8),
])
...
struct_alloc_object_FERMI_VASPACE_A_v03_00.register_fields([
  ("index", NvU32, 0),
  ("flags", NvU32, 4),
  ("vaSize", NvU64, 8),
  ("bigPageSize", NvU32, 16),
  ("vaBase", NvU64, 24),
])
...
struct_alloc_object_NV83DE_ALLOC_PARAMETERS_v03_00.register_fields([
  ("hDebuggerClient", NvHandle, 0),
  ("hAppClient", NvHandle, 4),
  ("hClass3dObject", NvHandle, 8),
])
...
struct_alloc_object_NVC4B0_VIDEO_DECODER_v12_02.register_fields([
  ("size", NvU32, 0),
  ("prohibitMultipleInstances", NvU32, 4),
  ("engineInstance", NvU32, 8),
])
...
struct_alloc_object_NVFBC_SW_SESSION_v12_04.register_fields([
  ("displayOrdinal", NvU32, 0),
  ("sessionType", NvU32, 4),
  ("sessionFlags", NvU32, 8),
  ("hMaxResolution", NvU32, 12),
  ("vMaxResolution", NvU32, 16),
])
...
struct_alloc_object_NV_NVJPG_ALLOCATION_PARAMETERS_v20_02.register_fields([
  ("size", NvU32, 0),
  ("prohibitMultipleInstances", NvU32, 4),
  ("engineInstance", NvU32, 8),
])
...
struct_alloc_object_NV503B_ALLOC_PARAMETERS_v1D_02.register_fields([
  ("hSubDevice", NvHandle, 0),
  ("hPeerSubDevice", NvHandle, 4),
  ("subDevicePeerIdMask", NvU32, 8),
  ("peerSubDevicePeerIdMask", NvU32, 12),
  ("mailboxBar1Addr", NvU64, 16),
  ("mailboxTotalSize", NvU32, 24),
  ("flags", NvU32, 28),
])
...
struct_alloc_object_NV_MEMORY_VIRTUAL_ALLOCATION_PARAMS_v13_03.register_fields([
  ("offset", NvU64, 0),
  ("limit", NvU64, 8),
  ("hVASpace", NvHandle, 16),
])
...
struct_alloc_object_NV00F8_ALLOCATION_PARAMETERS_v1E_0C.register_fields([
  ("alignment", NvU64, 0),
  ("allocSize", NvU64, 8),
  ("pageSize", NvU32, 16),
  ("allocFlags", NvU32, 20),
  ("map", NV00F8_ALLOCATION_PARAMETERS_MAP_STRUCT_v1E_0C, 24),
])
...
union_alloc_object_params_v25_08.register_fields([
  ("param_NV50_TESLA", alloc_object_NV50_TESLA_v03_00, 0),
  ("param_GT212_DMA_COPY", alloc_object_GT212_DMA_COPY_v03_00, 0),
  ("param_GF100_DISP_SW", alloc_object_GF100_DISP_SW_v03_00, 0),
  ("param_KEPLER_CHANNEL_GROUP_A", alloc_object_KEPLER_CHANNEL_GROUP_A_v12_08, 0),
  ("param_FERMI_CONTEXT_SHARE_A", alloc_object_FERMI_CONTEXT_SHARE_A_v04_00, 0),
  ("param_NVD0B7_VIDEO_ENCODER", alloc_object_NVD0B7_VIDEO_ENCODER_v03_00, 0),
  ("param_FERMI_VASPACE_A", alloc_object_FERMI_VASPACE_A_v03_00, 0),
  ("param_NVB0B0_VIDEO_DECODER", alloc_object_NVB0B0_VIDEO_DECODER_v03_00, 0),
  ("param_NV83DE_ALLOC_PARAMETERS", alloc_object_NV83DE_ALLOC_PARAMETERS_v03_00, 0),
  ("param_NVENC_SW_SESSION", alloc_object_NVENC_SW_SESSION_v06_01, 0),
  ("param_NVC4B0_VIDEO_DECODER", alloc_object_NVC4B0_VIDEO_DECODER_v12_02, 0),
  ("param_NVFBC_SW_SESSION", alloc_object_NVFBC_SW_SESSION_v12_04, 0),
  ("param_NV_NVJPG_ALLOCATION_PARAMETERS", alloc_object_NV_NVJPG_ALLOCATION_PARAMETERS_v20_02, 0),
  ("param_NV503B_ALLOC_PARAMETERS", alloc_object_NV503B_ALLOC_PARAMETERS_v1D_02, 0),
  ("param_NVC637_ALLOCATION_PARAMETERS", alloc_object_NVC637_ALLOCATION_PARAMETERS_v13_00, 0),
  ("param_NV_MEMORY_VIRTUAL_ALLOCATION_PARAMS", alloc_object_NV_MEMORY_VIRTUAL_ALLOCATION_PARAMS_v13_03, 0),
  ("param_NVC638_ALLOCATION_PARAMETERS", alloc_object_NVC638_ALLOCATION_PARAMETERS_v18_06, 0),
  ("param_NV503C_ALLOC_PARAMETERS", alloc_object_NV503C_ALLOC_PARAMETERS_v18_15, 0),
  ("param_NVC670_ALLOCATION_PARAMETERS", alloc_object_NVC670_ALLOCATION_PARAMETERS_v1A_01, 0),
  ("param_NVB1CC_ALLOC_PARAMETERS", alloc_object_NVB1CC_ALLOC_PARAMETERS_v1A_03, 0),
  ("param_NVB2CC_ALLOC_PARAMETERS", alloc_object_NVB2CC_ALLOC_PARAMETERS_v1A_03, 0),
  ("param_NV_GR_ALLOCATION_PARAMETERS", NV_GR_ALLOCATION_PARAMETERS_v1A_17, 0),
  ("param_NV_UVM_CHANNEL_RETAINER_ALLOC_PARAMS", alloc_object_NV_UVM_CHANNEL_RETAINER_ALLOC_PARAMS_v1A_1B, 0),
  ("param_NV00F8_ALLOCATION_PARAMETERS", alloc_object_NV00F8_ALLOCATION_PARAMETERS_v1E_0C, 0),
  ("param_NVC9FA_VIDEO_OFA", alloc_object_NVC9FA_VIDEO_OFA_v1F_00, 0),
  ("param_NV2081_ALLOC_PARAMETERS", alloc_object_NV2081_ALLOC_PARAMETERS_v25_08, 0),
])
struct_rpc_alloc_object_v25_08.register_fields([
  ("hClient", NvHandle, 0),
  ("hParent", NvHandle, 4),
  ("hObject", NvHandle, 8),
  ("hClass", NvU32, 12),
  ("param_len", NvU32, 16),
  ("params", alloc_object_params_v25_08, 24),
])
...
union_alloc_object_params_v26_00.register_fields([
  ("param_NV50_TESLA", alloc_object_NV50_TESLA_v03_00, 0),
  ("param_GT212_DMA_COPY", alloc_object_GT212_DMA_COPY_v03_00, 0),
  ("param_GF100_DISP_SW", alloc_object_GF100_DISP_SW_v03_00, 0),
  ("param_KEPLER_CHANNEL_GROUP_A", alloc_object_KEPLER_CHANNEL_GROUP_A_v12_08, 0),
...
struct_rpc_alloc_object_v26_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hParent", NvHandle, 4),
  ("hObject", NvHandle, 8),
  ("hClass", NvU32, 12),
  ("param_len", NvU32, 16),
  ("params", alloc_object_params_v26_00, 24),
])
...
union_alloc_object_params_v27_00.register_fields([
  ("param_NV50_TESLA", alloc_object_NV50_TESLA_v03_00, 0),
  ("param_GT212_DMA_COPY", alloc_object_GT212_DMA_COPY_v03_00, 0),
  ("param_GF100_DISP_SW", alloc_object_GF100_DISP_SW_v03_00, 0),
  ("param_KEPLER_CHANNEL_GROUP_A", alloc_object_KEPLER_CHANNEL_GROUP_A_v12_08, 0),
...
struct_rpc_alloc_object_v27_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hParent", NvHandle, 4),
  ("hObject", NvHandle, 8),
  ("hClass", NvU32, 12),
  ("param_len", NvU32, 16),
  ("params", alloc_object_params_v27_00, 24),
])
...
struct_alloc_object_NVC9FA_VIDEO_OFA_v29_06.register_fields([
  ("size", NvU32, 0),
  ("prohibitMultipleInstances", NvU32, 4),
  ("engineInstance", NvU32, 8),
])
union_alloc_object_params_v29_06.register_fields([
  ...
  ("param_NV_UVM_CHANNEL_RETAINER_ALLOC_PARAMS", alloc_object_NV_UVM_CHANNEL_RETAINER_ALLOC_PARAMS_v1A_1B, 0),
  ("param_NV00F8_ALLOCATION_PARAMETERS", alloc_object_NV00F8_ALLOCATION_PARAMETERS_v1E_0C, 0),
  ("param_NVC9FA_VIDEO_OFA", alloc_object_NVC9FA_VIDEO_OFA_v29_06, 0),
  ("param_NV2081_ALLOC_PARAMETERS", alloc_object_NV2081_ALLOC_PARAMETERS_v25_08, 0),
  ("param_padding", c.Array[NvU8, Literal[56]], 0),
])
struct_rpc_alloc_object_v29_06.register_fields([
  ("hClient", NvHandle, 0),
  ("hParent", NvHandle, 4),
  ("hObject", NvHandle, 8),
  ("hClass", NvU32, 12),
  ("param_len", NvU32, 16),
  ("params", alloc_object_params_v29_06, 24),
])
...
struct_NVOS00_PARAMETERS_v03_00.register_fields([
  ("hRoot", NvHandle, 0),
  ("hObjectParent", NvHandle, 4),
  ("hObjectOld", NvHandle, 8),
  ("status", NvV32, 12),
])
...
struct_NVOS46_PARAMETERS_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hDevice", NvHandle, 4),
  ("hDma", NvHandle, 8),
  ("hMemory", NvHandle, 12),
...
struct_NVOS47_PARAMETERS_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hDevice", NvHandle, 4),
  ("hDma", NvHandle, 8),
  ("hMemory", NvHandle, 12),
...
struct_NVOS21_PARAMETERS_v03_00.register_fields([
  ("hRoot", NvHandle, 0),
  ("hObjectParent", NvHandle, 4),
  ("hObjectNew", NvHandle, 8),
  ("hClass", NvV32, 12),
  ("pAllocParms", NvP64, 16),
  ("status", NvV32, 24),
])
...
struct_NVOS55_PARAMETERS_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hParent", NvHandle, 4),
  ("hObject", NvHandle, 8),
  ("hClientSrc", NvHandle, 12),
  ("hObjectSrc", NvHandle, 16),
  ("flags", NvU32, 20),
  ("status", NvU32, 24),
])
...
struct_rpc_idle_channels_v03_00.register_fields([
  ("flags", NvU32, 0),
  ("timeout", NvU32, 4),
  ("nchannels", NvU32, 8),
  ("channel_list", c.Array[idle_channel_list_v03_00, Literal[0]], 12),
])
...
struct_rpc_alloc_event_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hParentClient", NvHandle, 4),
  ("hChannel", NvHandle, 8),
  ("hObject", NvHandle, 12),
  ("hEvent", NvHandle, 16),
  ("hClass", NvU32, 20),
  ("notifyIndex", NvU32, 24),
])
...
struct_NVOS54_PARAMETERS_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("cmd", NvRmctrlCmd, 8),
  ("params", NvP64, 16),
...
struct_NV_DEVICE_ALLOCATION_PARAMETERS_v03_00.register_fields([
  ("szName", NvP64, 0),
  ("hClientShare", NvHandle, 8),
  ("hTargetClient", NvHandle, 12),
  ("hTargetDevice", NvHandle, 16),
  ("flags", NvV32, 20),
  ("vaSpaceSize", NvU64, 24),
  ("vaMode", NvV32, 32),
  ("vaBase", NvU64, 40),
])
struct_rpc_alloc_share_device_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hDevice", NvHandle, 4),
  ("hClass", NvU32, 8),
  ("params", NV_DEVICE_ALLOCATION_PARAMETERS_v03_00, 16),
])
...
enum_NV2080_CTRL_CMD_PERF_VID_ENG: dict[int, str] = {
  (NV2080_CTRL_CMD_PERF_VID_ENG_NVENC := 1): "NV2080_CTRL_CMD_PERF_VID_ENG_NVENC",
  (NV2080_CTRL_CMD_PERF_VID_ENG_NVDEC := 2): "NV2080_CTRL_CMD_PERF_VID_ENG_NVDEC",
  (NV2080_CTRL_CMD_PERF_VID_ENG_NVJPG := 3): "NV2080_CTRL_CMD_PERF_VID_ENG_NVJPG",
  (NV2080_CTRL_CMD_PERF_VID_ENG_NVOFA := 4): "NV2080_CTRL_CMD_PERF_VID_ENG_NVOFA",
}
NV2080_CTRL_CMD_PERF_VID_ENG: TypeAlias = ctypes.c_uint32
struct_NV2080_CTRL_PERF_GET_VID_ENG_PERFMON_SAMPLE_PARAMS_v05_00.register_fields([
  ("engineType", NV2080_CTRL_CMD_PERF_VID_ENG, 0),
  ("clkPercentBusy", NvU32, 4),
  ("samplingPeriodUs", NvU32, 8),
])
...
struct_NV0000_CTRL_GPUACCT_GET_ACCOUNTING_PIDS_PARAMS_v09_0C.register_fields([
  ("gpuId", NvU32, 0),
  ("vmPid", NvU32, 4),
  ("passIndex", NvU32, 8),
  ("pidCount", NvU32, 12),
  ("pidTable", c.Array[NvU32, Literal[1000]], 16),
])
...
struct_NV0000_CTRL_GPUACCT_GET_PROC_ACCOUNTING_INFO_PARAMS_v09_0C.register_fields([
  ("gpuId", NvU32, 0),
  ("pid", NvU32, 4),
  ("subPid", NvU32, 8),
  ("gpuUtil", NvU32, 12),
...
struct_NV2080_CTRL_PERF_GPUMON_PERFMON_UTIL_SAMPLE_v1F_0E.register_fields([
  ("timeStamp", NvU64, 0),
  ("fb", NV2080_CTRL_PERF_GPUMON_ENGINE_UTIL_SAMPLE_v17_00, 8),
  ("gr", NV2080_CTRL_PERF_GPUMON_ENGINE_UTIL_SAMPLE_v17_00, 20),
  ("nvenc", NV2080_CTRL_PERF_GPUMON_ENGINE_UTIL_SAMPLE_v17_00, 32),
  ("nvdec", NV2080_CTRL_PERF_GPUMON_ENGINE_UTIL_SAMPLE_v17_00, 44),
])
union_vgpuGetEngineUtilization_data_v1F_0E.register_fields([
  ("vidPerfmonSample", NV2080_CTRL_PERF_GET_VID_ENG_PERFMON_SAMPLE_PARAMS_v05_00, 0),
  ("getAccountingState", NV0000_CTRL_GPUACCT_GET_ACCOUNTING_STATE_PARAMS_v09_0C, 0),
  ("setAccountingState", NV0000_CTRL_GPUACCT_SET_ACCOUNTING_STATE_PARAMS_v09_0C, 0),
  ("getAccountingPidList", NV0000_CTRL_GPUACCT_GET_ACCOUNTING_PIDS_PARAMS_v09_0C, 0),
  ("procAccountingInfo", NV0000_CTRL_GPUACCT_GET_PROC_ACCOUNTING_INFO_PARAMS_v09_0C, 0),
  ("clearAccountingInfo", NV0000_CTRL_GPUACCT_CLEAR_ACCOUNTING_DATA_PARAMS_v09_0C, 0),
  ("gpumonPerfmonsampleV2", c.Array[NV2080_CTRL_PERF_GPUMON_PERFMON_UTIL_SAMPLE_v1F_0E, Literal[72]], 0),
])
struct_rpc_get_engine_utilization_v1F_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("cmd", NvU32, 8),
  ("params", vgpuGetEngineUtilization_data_v1F_0E, 16),
])
...
struct_rpc_perf_get_level_info_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("level", NvU32, 8),
  ("flags", NvU32, 12),
  ("perfGetClkInfoListSize", NvU32, 16),
  ("param_size", NvU32, 20),
  ("params", c.Array[NvU32, Literal[0]], 24),
])
...
struct_NVA080_CTRL_VGPU_DISPLAY_SET_SURFACE_PROPERTIES_v07_07.register_fields([
  ("headIndex", NvU32, 0),
  ("isPrimary", NvU32, 4),
  ("offset", NvU32, 8),
  ("surfaceType", NvU32, 12),
  ("surfaceBlockHeight", NvU32, 16),
  ("surfacePitch", NvU32, 20),
  ("surfaceFormat", NvU32, 24),
  ("surfaceWidth", NvU32, 28),
  ("surfaceHeight", NvU32, 32),
  ("rectX", NvU32, 36),
  ("rectY", NvU32, 40),
  ("rectWidth", NvU32, 44),
  ("rectHeight", NvU32, 48),
  ("surfaceSize", NvU32, 52),
  ("surfaceKind", NvU32, 56),
  ("hHwResDevice", NvU32, 60),
  ("hHwResHandle", NvU32, 64),
  ("effectiveFbPageSize", NvU32, 68),
])
struct_rpc_set_surface_properties_v07_07.register_fields([
  ("hClient", NvHandle, 0),
  ("params", NVA080_CTRL_VGPU_DISPLAY_SET_SURFACE_PROPERTIES_v07_07, 4),
])
...
struct_NV2080_CTRL_GPU_EXEC_REG_OPS_PARAMS_v12_01.register_fields([
  ("hClientTarget", NvHandle, 0),
  ("hChannelTarget", NvHandle, 4),
  ("reserved00", c.Array[NvU32, Literal[3]], 8),
  ("regOpCount", NvU32, 20),
  ("grRouteInfo", NV2080_CTRL_GR_ROUTE_INFO_v12_01, 24),
  ("regOps", NvP64, 40),
])
...
struct_NV2080_CTRL_GPU_REG_OP_v03_00.register_fields([
  ("regOp", NvU8, 0),
  ("regType", NvU8, 1),
  ("regStatus", NvU8, 2),
  ("regQuad", NvU8, 3),
  ("regGroupMask", NvU32, 4),
  ("regSubGroupMask", NvU32, 8),
  ("regOffset", NvU32, 12),
  ("regValueHi", NvU32, 16),
  ("regValueLo", NvU32, 20),
  ("regAndNMaskHi", NvU32, 24),
  ("regAndNMaskLo", NvU32, 28),
])
struct_gpu_exec_reg_ops_v12_01.register_fields([
  ("reg_op_params", NV2080_CTRL_GPU_EXEC_REG_OPS_PARAMS_v12_01, 0),
  ("operations", c.Array[NV2080_CTRL_GPU_REG_OP_v03_00, Literal[0]], 48),
])
...
struct_rpc_get_consolidated_gr_static_info_v1B_04.register_fields([
  ("offset", NvU32, 0),
  ("size", NvU32, 4),
  ("payload", c.Array[NvU8, Literal[0]], 8),
])
...
struct_NV0080_CTRL_DMA_SET_PAGE_DIRECTORY_PARAMS_v1E_05.register_fields([
  ("physAddress", NvU64, 0),
  ("numEntries", NvU32, 8),
  ("flags", NvU32, 12),
  ("hVASpace", NvHandle, 16),
  ("chId", NvU32, 20),
  ("subDeviceId", NvU32, 24),
  ("pasid", NvU32, 28),
])
struct_rpc_set_page_directory_v1E_05.register_fields([
  ("hClient", NvHandle, 0),
  ("hDevice", NvHandle, 4),
  ("pasid", NvU32, 8),
  ("params", NV0080_CTRL_DMA_SET_PAGE_DIRECTORY_PARAMS_v1E_05, 16),
])
...
struct_rpc_unset_page_directory_v1E_05.register_fields([
  ("hClient", NvHandle, 0),
  ("hDevice", NvHandle, 4),
  ("params", NV0080_CTRL_DMA_UNSET_PAGE_DIRECTORY_PARAMS_v1E_05, 8),
])
...
struct_NVA0BC_CTRL_NVENC_SW_SESSION_UPDATE_INFO_PARAMS_v06_01.register_fields([
  ("hResolution", NvU32, 0),
  ("vResolution", NvU32, 4),
  ("averageEncodeLatency", NvU32, 8),
  ("averageEncodeFps", NvU32, 12),
  ("timestampBufferSize", NvU32, 16),
  ("timestampBuffer", NvP64, 24),
])
struct_rpc_ctrl_nvenc_sw_session_update_info_v1A_09.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("nvencSessionUpdate", NVA0BC_CTRL_NVENC_SW_SESSION_UPDATE_INFO_PARAMS_v06_01, 8),
])
...
struct_NV906F_CTRL_CMD_RESET_CHANNEL_PARAMS_v10_01.register_fields([
  ("engineID", NvU32, 0),
  ("subdeviceInstance", NvU32, 4),
  ("resetReason", NvU32, 8),
])
struct_rpc_ctrl_reset_channel_v1A_09.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("resetChannel", NV906F_CTRL_CMD_RESET_CHANNEL_PARAMS_v10_01, 8),
])
...
struct_rpc_ctrl_reset_isolated_channel_v1A_09.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("resetIsolatedChannel", NV506F_CTRL_CMD_RESET_ISOLATED_CHANNEL_PARAMS_v03_00, 8),
])
...
struct_rpc_ctrl_gpu_handle_vf_pri_fault_v1A_09.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("handleVfPriFault", NV2080_CTRL_CMD_GPU_HANDLE_VF_PRI_FAULT_PARAMS_v18_09, 8),
])
...
struct_rpc_ctrl_perf_boost_v1A_09.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("perfBoost", NV2080_CTRL_PERF_BOOST_PARAMS_v03_00, 8),
])
...
struct_NV9096_CTRL_GET_ZBC_CLEAR_TABLE_PARAMS_value_v04_00.register_fields([
  ("colorFB", c.Array[NvU32, Literal[4]], 0),
  ("colorDS", c.Array[NvU32, Literal[4]], 16),
  ("depth", NvU32, 32),
  ("stencil", NvU32, 36),
])
struct_NV9096_CTRL_GET_ZBC_CLEAR_TABLE_PARAMS_v04_00.register_fields([
  ("value", NV9096_CTRL_GET_ZBC_CLEAR_TABLE_PARAMS_value_v04_00, 0),
  ("indexSize", NvU32, 40),
  ("indexUsed", NvU32, 44),
  ("format", NvU32, 48),
  ("valType", NvU32, 52),
])
struct_rpc_ctrl_get_zbc_clear_table_v1A_09.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("getZbcClearTable", NV9096_CTRL_GET_ZBC_CLEAR_TABLE_PARAMS_v04_00, 8),
])
...
struct_NV9096_CTRL_SET_ZBC_COLOR_CLEAR_PARAMS_v03_00.register_fields([
  ("colorFB", c.Array[NvU32, Literal[4]], 0),
  ("colorDS", c.Array[NvU32, Literal[4]], 16),
  ("format", NvU32, 32),
])
struct_rpc_ctrl_set_zbc_color_clear_v1A_09.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("setZbcColorClr", NV9096_CTRL_SET_ZBC_COLOR_CLEAR_PARAMS_v03_00, 8),
])
...
struct_rpc_ctrl_set_zbc_depth_clear_v1A_09.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("setZbcDepthClr", NV9096_CTRL_SET_ZBC_DEPTH_CLEAR_PARAMS_v03_00, 8),
])
...
struct_rpc_ctrl_set_zbc_stencil_clear_v27_06.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("setZbcStencilClr", NV9096_CTRL_SET_ZBC_STENCIL_CLEAR_PARAMS_v27_06, 8),
])
...
struct_rpc_ctrl_gpfifo_schedule_v1A_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("cmd", NvU32, 8),
  ("gpfifoSchedule", NVA06F_CTRL_GPFIFO_SCHEDULE_PARAMS_v03_00, 12),
])
...
struct_rpc_ctrl_set_timeslice_v1A_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("setTimeSlice", NVA06C_CTRL_TIMESLICE_PARAMS_v06_00, 8),
])
...
struct_NV2080_CTRL_FIFO_DISABLE_CHANNELS_PARAMS_v06_00.register_fields([
  ("bDisable", NvBool, 0),
  ("numChannels", NvU32, 4),
  ("bOnlyDisableScheduling", NvBool, 8),
  ("bRewindGpPut", NvBool, 9),
  ("pRunlistPreemptEvent", NvP64, 16),
  ("hClientList", c.Array[NvHandle, Literal[64]], 24),
  ("hChannelList", c.Array[NvHandle, Literal[64]], 280),
])
struct_rpc_ctrl_fifo_disable_channels_v1A_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("fifoDisableChannels", NV2080_CTRL_FIFO_DISABLE_CHANNELS_PARAMS_v06_00, 8),
])
...
struct_rpc_ctrl_preempt_v1A_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("cmdPreempt", NVA06C_CTRL_PREEMPT_PARAMS_v09_0A, 8),
])
...
struct_rpc_ctrl_set_tsg_interleave_level_v1A_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("interleaveLevelTSG", NVA06C_CTRL_INTERLEAVE_LEVEL_PARAMS_v17_02, 8),
])
...
struct_rpc_ctrl_set_channel_interleave_level_v1A_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("interleaveLevelChannel", NVA06F_CTRL_INTERLEAVE_LEVEL_PARAMS_v17_02, 8),
])
...
struct_NV2080_CTRL_GR_CTXSW_PREEMPTION_BIND_PARAMS_v12_01.register_fields([
  ("flags", NvU32, 0),
  ("hClient", NvHandle, 4),
  ("hChannel", NvHandle, 8),
  ("vMemPtrs", c.Array[NvU64, Literal[8]], 16),
  ("gfxpPreemptMode", NvU32, 80),
  ("cilpPreemptMode", NvU32, 84),
  ("grRouteInfo", NV2080_CTRL_GR_ROUTE_INFO_v12_01, 88),
])
struct_rpc_ctrl_gr_ctxsw_preemption_bind_v1A_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_GR_CTXSW_PREEMPTION_BIND_PARAMS_v12_01, 8),
])
...
struct_NV2080_CTRL_GR_CTXSW_PREEMPTION_BIND_PARAMS_v28_07.register_fields([
  ("flags", NvU32, 0),
  ("hClient", NvHandle, 4),
  ("hChannel", NvHandle, 8),
  ("vMemPtrs", c.Array[NvU64, Literal[9]], 16),
  ("gfxpPreemptMode", NvU32, 88),
  ("cilpPreemptMode", NvU32, 92),
  ("grRouteInfo", NV2080_CTRL_GR_ROUTE_INFO_v12_01, 96),
])
struct_rpc_ctrl_gr_ctxsw_preemption_bind_v28_07.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_GR_CTXSW_PREEMPTION_BIND_PARAMS_v28_07, 8),
])
...
struct_NV2080_CTRL_GR_SET_CTXSW_PREEMPTION_MODE_PARAMS_v12_01.register_fields([
  ("flags", NvU32, 0),
  ("hChannel", NvHandle, 4),
  ("gfxpPreemptMode", NvU32, 8),
  ("cilpPreemptMode", NvU32, 12),
  ("grRouteInfo", NV2080_CTRL_GR_ROUTE_INFO_v12_01, 16),
])
struct_rpc_ctrl_gr_set_ctxsw_preemption_mode_v1A_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_GR_SET_CTXSW_PREEMPTION_MODE_PARAMS_v12_01, 8),
])
...
struct_NV2080_CTRL_GR_CTXSW_ZCULL_BIND_PARAMS_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hChannel", NvHandle, 4),
  ("vMemPtr", NvU64, 8),
  ("zcullMode", NvU32, 16),
])
struct_rpc_ctrl_gr_ctxsw_zcull_bind_v1A_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_GR_CTXSW_ZCULL_BIND_PARAMS_v03_00, 8),
])
...
struct_NV2080_CTRL_GPU_INITIALIZE_CTX_PARAMS_v03_00.register_fields([
  ("engineType", NvU32, 0),
  ("hClient", NvHandle, 4),
  ("ChID", NvU32, 8),
  ("hChanClient", NvHandle, 12),
  ("hObject", NvHandle, 16),
  ("hVirtMemory", NvHandle, 20),
  ("physAddress", NvU64, 24),
  ("physAttr", NvU32, 32),
  ("hDmaHandle", NvHandle, 36),
  ("index", NvU32, 40),
  ("size", NvU64, 48),
])
struct_rpc_ctrl_gpu_initialize_ctx_v1A_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_GPU_INITIALIZE_CTX_PARAMS_v03_00, 8),
])
...
NV90F1_CTRL_VASPACE_COPY_SERVER_RESERVED_PDES_PARAMS_levels_v1E_04: TypeAlias = (
  struct_NV90F1_CTRL_VASPACE_COPY_SERVER_RESERVED_PDES_PARAMS_levels_v1E_04
)
struct_NV90F1_CTRL_VASPACE_COPY_SERVER_RESERVED_PDES_PARAMS_levels_v1E_04.register_fields([
  ("physAddress", NvU64, 0),
  ("size", NvU64, 8),
  ("aperture", NvU32, 16),
  ("pageShift", NvU8, 20),
])
struct_NV90F1_CTRL_VASPACE_COPY_SERVER_RESERVED_PDES_PARAMS_v1E_04.register_fields([
  ("hSubDevice", NvHandle, 0),
  ("subDeviceId", NvU32, 4),
  ("pageSize", NvU64, 8),
  ("virtAddrLo", NvU64, 16),
  ("virtAddrHi", NvU64, 24),
  ("numLevelsToCopy", NvU32, 32),
  ("levels", c.Array[NV90F1_CTRL_VASPACE_COPY_SERVER_RESERVED_PDES_PARAMS_levels_v1E_04, Literal[6]], 40),
])
struct_rpc_ctrl_vaspace_copy_server_reserved_pdes_v1E_04.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV90F1_CTRL_VASPACE_COPY_SERVER_RESERVED_PDES_PARAMS_v1E_04, 8),
])
...
struct_rpc_ctrl_mc_service_interrupts_v1A_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_MC_SERVICE_INTERRUPTS_PARAMS_v15_01, 8),
])
...
struct_rpc_ctrl_get_p2p_caps_v2_v1F_0D.register_fields([
  ("iter", NvU8, 0),
  ("gpuIds", c.Array[NvU32, Literal[32]], 4),
  ("gpuCount", NvU32, 132),
  ("p2pCaps", NvU32, 136),
  ("p2pOptimalReadCEs", NvU32, 140),
  ("p2pOptimalWriteCEs", NvU32, 144),
  ("p2pCapsStatus", c.Array[NvU8, Literal[9]], 148),
  ("busPeerIds", c.Array[NvU32, Literal[512]], 160),
])
...
struct_NV2080_CTRL_GPU_P2P_PEER_CAPS_PEER_INFO_v21_02.register_fields([
  ("gpuId", NvU32, 0),
  ("gpuUuid", c.Array[NvU8, Literal[16]], 4),
  ("p2pCaps", NvU32, 20),
  ("p2pOptimalReadCEs", NvU32, 24),
  ("p2pOptimalWriteCEs", NvU32, 28),
  ("p2pCapsStatus", c.Array[NvU8, Literal[9]], 32),
  ("busPeerId", NvU32, 44),
])
struct_NV2080_CTRL_GET_P2P_CAPS_PARAMS_v21_02.register_fields([
  ("bAllCaps", NvBool, 0),
  ("bUseUuid", NvBool, 1),
  ("peerGpuCount", NvU32, 4),
  ("peerGpuCaps", c.Array[NV2080_CTRL_GPU_P2P_PEER_CAPS_PEER_INFO_v21_02, Literal[32]], 8),
])
...
struct_NV2080_CTRL_CMD_GSP_GET_VGPU_HEAP_STATS_PARAMS_v28_03.register_fields([
  ("allocatedSize", NvU64, 0),
  ("peakAllocatedSize", NvU64, 8),
  ("managedSize", NvU64, 16),
  ("allocationCount", NvU32, 24),
  ("peakAllocationCount", NvU32, 28),
])
struct_rpc_ctrl_subdevice_get_vgpu_heap_stats_v28_03.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_CMD_GSP_GET_VGPU_HEAP_STATS_PARAMS_v28_03, 8),
])
...
struct_NV2080_CTRL_CMD_GSP_GET_VGPU_HEAP_STATS_PARAMS_v28_06.register_fields([
  ("allocatedSize", NvU64, 0),
  ("peakAllocatedSize", NvU64, 8),
  ("managedSize", NvU64, 16),
  ("allocationCount", NvU32, 24),
  ("peakAllocationCount", NvU32, 28),
  ("largestFreeChunkSize", NvU64, 32),
])
struct_rpc_ctrl_subdevice_get_vgpu_heap_stats_v28_06.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_CMD_GSP_GET_VGPU_HEAP_STATS_PARAMS_v28_06, 8),
])
...
struct_rpc_ctrl_dbg_clear_all_sm_error_states_v1A_0C.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_CLEAR_ALL_SM_ERROR_STATES_PARAMS_v03_00, 8),
])
...
struct_NV83DE_SM_ERROR_STATE_REGISTERS_v21_06.register_fields([
  ("hwwGlobalEsr", NvU32, 0),
  ("hwwWarpEsr", NvU32, 4),
  ("hwwWarpEsrPc", NvU32, 8),
  ("hwwGlobalEsrReportMask", NvU32, 12),
  ("hwwWarpEsrReportMask", NvU32, 16),
  ("hwwEsrAddr", NvU64, 24),
  ("hwwWarpEsrPc64", NvU64, 32),
  ("hwwCgaEsr", NvU32, 40),
  ("hwwCgaEsrReportMask", NvU32, 44),
])
...
struct_NV83DE_CTRL_DEBUG_READ_ALL_SM_ERROR_STATES_PARAMS_v21_06.register_fields([
  ("hTargetChannel", NvHandle, 0),
  ("numSMsToRead", NvU32, 4),
  ("smErrorStateArray", c.Array[NV83DE_SM_ERROR_STATE_REGISTERS_v21_06, Literal[80]], 8),
  ("mmuFaultInfo", NvU32, 3848),
  ("mmuFault", NV83DE_MMU_FAULT_INFO_v16_03, 3852),
  ("startingSM", NvU32, 3860),
])
struct_rpc_ctrl_dbg_read_all_sm_error_states_v21_06.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_READ_ALL_SM_ERROR_STATES_PARAMS_v21_06, 8),
])
...
struct_rpc_ctrl_dbg_set_exception_mask_v1A_0C.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_SET_EXCEPTION_MASK_PARAMS_v03_00, 8),
])
...
struct_NV2080_CTRL_GPU_PROMOTE_CTX_BUFFER_ENTRY_v1A_20.register_fields([
  ("gpuPhysAddr", NvU64, 0),
  ("gpuVirtAddr", NvU64, 8),
  ("size", NvU64, 16),
  ("physAttr", NvU32, 24),
...
struct_NV2080_CTRL_GPU_PROMOTE_CTX_PARAMS_v1A_20.register_fields([
  ("engineType", NvU32, 0),
  ("hClient", NvHandle, 4),
  ("ChID", NvU32, 8),
  ("hChanClient", NvHandle, 12),
  ("hObject", NvHandle, 16),
  ("hVirtMemory", NvHandle, 20),
  ("virtAddress", NvU64, 24),
  ("size", NvU64, 32),
  ("entryCount", NvU32, 40),
  ("promoteEntry", c.Array[NV2080_CTRL_GPU_PROMOTE_CTX_BUFFER_ENTRY_v1A_20, Literal[16]], 48),
])
struct_rpc_ctrl_gpu_promote_ctx_v1A_20.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("promoteCtx", NV2080_CTRL_GPU_PROMOTE_CTX_PARAMS_v1A_20, 8),
])
...
struct_rpc_ctrl_dbg_suspend_context_v1A_10.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_CMD_DEBUG_SUSPEND_CONTEXT_PARAMS_v1A_06, 8),
])
...
struct_NV83DE_CTRL_DEBUG_EXEC_REG_OPS_PARAMS_v1A_06.register_fields([
  ("bNonTransactional", NvBool, 0),
  ("regOpCount", NvU32, 4),
  ("regOps", c.Array[NV2080_CTRL_GPU_REG_OP_v03_00, Literal[100]], 8),
])
struct_rpc_ctrl_dbg_exec_reg_ops_v1A_10.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_EXEC_REG_OPS_PARAMS_v1A_06, 8),
])
...
struct_rpc_ctrl_dbg_set_mode_mmu_debug_v1A_10.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_SET_MODE_MMU_DEBUG_PARAMS_v1A_06, 8),
])
...
struct_rpc_ctrl_dbg_set_mode_mmu_gcc_debug_v29_07.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_SET_MODE_MMU_GCC_DEBUG_PARAMS_v29_07, 8),
])
...
struct_NV83DE_CTRL_DEBUG_READ_SINGLE_SM_ERROR_STATE_PARAMS_v21_06.register_fields([
  ("hTargetChannel", NvHandle, 0),
  ("smID", NvU32, 4),
  ("smErrorState", NV83DE_SM_ERROR_STATE_REGISTERS_v21_06, 8),
])
struct_rpc_ctrl_dbg_read_single_sm_error_state_v21_06.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_READ_SINGLE_SM_ERROR_STATE_PARAMS_v21_06, 8),
])
...
struct_rpc_ctrl_dbg_clear_single_sm_error_state_v1A_10.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_CLEAR_SINGLE_SM_ERROR_STATE_PARAMS_v1A_06, 8),
])
...
struct_rpc_ctrl_dbg_set_mode_errbar_debug_v1A_10.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_SET_MODE_ERRBAR_DEBUG_PARAMS_v1A_06, 8),
])
...
struct_rpc_ctrl_dbg_set_next_stop_trigger_type_v1A_10.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_SET_NEXT_STOP_TRIGGER_TYPE_PARAMS_v1A_06, 8),
])
...
struct_rpc_ctrl_dma_set_default_vaspace_v1A_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV0080_CTRL_DMA_SET_DEFAULT_VASPACE_PARAMS_v03_00, 8),
])
...
struct_rpc_ctrl_get_ce_pce_mask_v1A_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_CE_GET_CE_PCE_MASK_PARAMS_v1A_07, 8),
])
...
struct_NV9096_CTRL_GET_ZBC_CLEAR_TABLE_ENTRY_PARAMS_value_v1A_07.register_fields([
  ("colorFB", c.Array[NvU32, Literal[4]], 0),
  ("colorDS", c.Array[NvU32, Literal[4]], 16),
  ("depth", NvU32, 32),
  ("stencil", NvU32, 36),
])
enum_NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE: dict[int, str] = {
  (NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_INVALID := 0): "NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_INVALID",
  (NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_COLOR := 1): "NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_COLOR",
  (NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_DEPTH := 2): "NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_DEPTH",
  (NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_STENCIL := 3): "NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_STENCIL",
  (NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_COUNT := 4): "NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE_COUNT",
}
NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE: TypeAlias = ctypes.c_uint32
struct_NV9096_CTRL_GET_ZBC_CLEAR_TABLE_ENTRY_PARAMS_v1A_07.register_fields([
  ("value", NV9096_CTRL_GET_ZBC_CLEAR_TABLE_ENTRY_PARAMS_value_v1A_07, 0),
  ("format", NvU32, 40),
  ("index", NvU32, 44),
  ("bIndexValid", NvBool, 48),
  ("tableType", NV9096_CTRL_ZBC_CLEAR_TABLE_TYPE, 52),
])
struct_rpc_ctrl_get_zbc_clear_table_entry_v1A_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV9096_CTRL_GET_ZBC_CLEAR_TABLE_ENTRY_PARAMS_v1A_07, 8),
])
...
struct_NV2080_CTRL_NVLINK_DEVICE_INFO_v15_02.register_fields([
  ("deviceIdFlags", NvU32, 0),
  ("domain", NvU32, 4),
  ("bus", NvU16, 8),
  ("device", NvU16, 10),
  ("function", NvU16, 12),
  ("pciDeviceId", NvU32, 16),
  ("deviceType", NvU64, 24),
  ("deviceUUID", c.Array[NvU8, Literal[16]], 32),
])
struct_NV2080_CTRL_NVLINK_LINK_STATUS_INFO_v18_0D.register_fields([
  ...
  ("subLinkWidth", NvU8, 5),
  ("linkState", NvU32, 8),
  ("rxSublinkStatus", NvU8, 12),
  ("txSublinkStatus", NvU8, 13),
  ("nvlinkVersion", NvU8, 14),
  ("nciVersion", NvU8, 15),
  ("phyVersion", NvU8, 16),
  ("nvlinkLinkClockKHz", NvU32, 20),
  ("nvlinkLineRateMbps", NvU32, 24),
  ("connected", NvBool, 28),
  ("remoteDeviceLinkNumber", NvU8, 29),
  ("localDeviceLinkNumber", NvU8, 30),
  ("remoteDeviceInfo", NV2080_CTRL_NVLINK_DEVICE_INFO_v15_02, 32),
  ("localDeviceInfo", NV2080_CTRL_NVLINK_DEVICE_INFO_v15_02, 80),
])
struct_NV2080_CTRL_CMD_NVLINK_GET_NVLINK_STATUS_PARAMS_v23_04.register_fields([
  ("enabledLinkMask", NvU32, 0),
  ("linkInfo", c.Array[NV2080_CTRL_NVLINK_LINK_STATUS_INFO_v18_0D, Literal[24]], 8),
])
struct_rpc_ctrl_get_nvlink_status_v23_04.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_CMD_NVLINK_GET_NVLINK_STATUS_PARAMS_v23_04, 8),
])
...
struct_NV2080_CTRL_NVLINK_DEVICE_INFO_v28_09.register_fields([
  ("deviceIdFlags", NvU32, 0),
  ("domain", NvU32, 4),
  ("bus", NvU16, 8),
  ("device", NvU16, 10),
  ...
  ("deviceType", NvU64, 24),
  ("deviceUUID", c.Array[NvU8, Literal[16]], 32),
  ("fabricRecoveryStatusMask", NvU32, 48),
])
struct_NV2080_CTRL_NVLINK_LINK_STATUS_INFO_v28_09.register_fields([
  ("capsTbl", NvU32, 0),
  ("phyType", NvU8, 4),
  ("subLinkWidth", NvU8, 5),
  ("linkState", NvU32, 8),
  ...
  ("remoteDeviceLinkNumber", NvU8, 29),
  ("localDeviceLinkNumber", NvU8, 30),
  ("remoteDeviceInfo", NV2080_CTRL_NVLINK_DEVICE_INFO_v28_09, 32),
  ("localDeviceInfo", NV2080_CTRL_NVLINK_DEVICE_INFO_v28_09, 88),
])
struct_NV2080_CTRL_CMD_NVLINK_GET_NVLINK_STATUS_PARAMS_v28_09.register_fields([
  ("enabledLinkMask", NvU32, 0),
  ("linkInfo", c.Array[NV2080_CTRL_NVLINK_LINK_STATUS_INFO_v28_09, Literal[24]], 8),
])
struct_rpc_ctrl_get_nvlink_status_v28_09.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_CMD_NVLINK_GET_NVLINK_STATUS_PARAMS_v28_09, 8),
])
...
struct_NV0000_CTRL_SYSTEM_GET_P2P_CAPS_PARAMS_v1F_0D.register_fields([
  ("gpuIds", c.Array[NvU32, Literal[32]], 0),
  ("gpuCount", NvU32, 128),
  ("p2pCaps", NvU32, 132),
  ("p2pOptimalReadCEs", NvU32, 136),
  ("p2pOptimalWriteCEs", NvU32, 140),
  ("p2pCapsStatus", c.Array[NvU8, Literal[9]], 144),
])
struct_rpc_ctrl_get_p2p_caps_v1F_0D.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV0000_CTRL_SYSTEM_GET_P2P_CAPS_PARAMS_v1F_0D, 8),
])
...
struct_NV0000_CTRL_SYSTEM_GET_P2P_CAPS_MATRIX_PARAMS_v18_0A.register_fields([
  ("grpACount", NvU32, 0),
  ("grpBCount", NvU32, 4),
  ("gpuIdGrpA", c.Array[NvU32, Literal[8]], 8),
  ("gpuIdGrpB", c.Array[NvU32, Literal[8]], 40),
  ("p2pCaps", c.Array[NV0000_CTRL_P2P_CAPS_MATRIX_ROW_v18_0A, Literal[8]], 72),
  ("a2bOptimalReadCes", c.Array[NV0000_CTRL_P2P_CAPS_MATRIX_ROW_v18_0A, Literal[8]], 328),
  ("a2bOptimalWriteCes", c.Array[NV0000_CTRL_P2P_CAPS_MATRIX_ROW_v18_0A, Literal[8]], 584),
  ("b2aOptimalReadCes", c.Array[NV0000_CTRL_P2P_CAPS_MATRIX_ROW_v18_0A, Literal[8]], 840),
  ("b2aOptimalWriteCes", c.Array[NV0000_CTRL_P2P_CAPS_MATRIX_ROW_v18_0A, Literal[8]], 1096),
])
struct_rpc_ctrl_get_p2p_caps_matrix_v1A_0E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV0000_CTRL_SYSTEM_GET_P2P_CAPS_MATRIX_PARAMS_v18_0A, 8),
])
...
struct_rpc_ctrl_reserve_pm_area_smpc_v1A_0F.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_RESERVE_PM_AREA_SMPC_PARAMS_v1A_0F, 8),
])
...
struct_rpc_ctrl_reserve_hwpm_legacy_v1A_0F.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_RESERVE_HWPM_LEGACY_PARAMS_v1A_0F, 8),
])
...
enum_NVB0CC_REGOPS_MODE: dict[int, str] = {
  (NVB0CC_REGOPS_MODE_ALL_OR_NONE := 0): "NVB0CC_REGOPS_MODE_ALL_OR_NONE",
  (NVB0CC_REGOPS_MODE_CONTINUE_ON_ERROR := 1): "NVB0CC_REGOPS_MODE_CONTINUE_ON_ERROR",
}
NVB0CC_REGOPS_MODE: TypeAlias = ctypes.c_uint32
struct_NVB0CC_CTRL_EXEC_REG_OPS_PARAMS_v1A_0F.register_fields([
  ("regOpCount", NvU32, 0),
  ("mode", NVB0CC_REGOPS_MODE, 4),
  ("bPassed", NvBool, 8),
  ("bDirect", NvBool, 9),
  ("regOps", c.Array[NV2080_CTRL_GPU_REG_OP_v03_00, Literal[124]], 12),
])
struct_rpc_ctrl_b0cc_exec_reg_ops_v1A_0F.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_EXEC_REG_OPS_PARAMS_v1A_0F, 8),
])
...
struct_NVB0CC_CTRL_ALLOC_PMA_STREAM_PARAMS_v1A_14.register_fields([
  ("hMemPmaBuffer", NvHandle, 0),
  ("pmaBufferOffset", NvU64, 8),
  ("pmaBufferSize", NvU64, 16),
  ("hMemPmaBytesAvailable", NvHandle, 24),
  ("pmaBytesAvailableOffset", NvU64, 32),
  ("ctxsw", NvBool, 40),
  ("pmaChannelIdx", NvU32, 44),
  ("pmaBufferVA", NvU64, 48),
])
struct_rpc_ctrl_alloc_pma_stream_v1A_14.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_ALLOC_PMA_STREAM_PARAMS_v1A_14, 8),
])
...
struct_NVB0CC_CTRL_PMA_STREAM_UPDATE_GET_PUT_PARAMS_v1A_14.register_fields([
  ("bytesConsumed", NvU64, 0),
  ("bUpdateAvailableBytes", NvBool, 8),
  ("bWait", NvBool, 9),
  ("bytesAvailable", NvU64, 16),
  ("bReturnPut", NvBool, 24),
  ("putPtr", NvU64, 32),
  ("pmaChannelIdx", NvU32, 40),
])
struct_rpc_ctrl_pma_stream_update_get_put_v1A_14.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_PMA_STREAM_UPDATE_GET_PUT_PARAMS_v1A_14, 8),
])
...
struct_NV2080_CTRL_FB_GET_INFO_V2_PARAMS_v25_0A.register_fields([
  ("fbInfoListSize", NvU32, 0),
  ("fbInfoList", c.Array[NV2080_CTRL_FB_INFO_v1A_15, Literal[55]], 4),
])
struct_rpc_ctrl_fb_get_info_v2_v25_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_FB_GET_INFO_V2_PARAMS_v25_0A, 8),
])
...
struct_NV2080_CTRL_FB_GET_INFO_V2_PARAMS_v27_00.register_fields([
  ("fbInfoListSize", NvU32, 0),
  ("fbInfoList", c.Array[NV2080_CTRL_FB_INFO_v1A_15, Literal[57]], 4),
])
struct_rpc_ctrl_fb_get_info_v2_v27_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_FB_GET_INFO_V2_PARAMS_v27_00, 8),
])
...
struct_rpc_ctrl_fifo_set_channel_properties_v1A_16.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV0080_CTRL_FIFO_SET_CHANNEL_PROPERTIES_PARAMS_v03_00, 8),
])
...
struct_NV2080_CTRL_GPU_EVICT_CTX_PARAMS_v03_00.register_fields([
  ("engineType", NvU32, 0),
  ("hClient", NvHandle, 4),
  ("ChID", NvU32, 8),
  ("hChanClient", NvHandle, 12),
...
struct_rpc_ctrl_gpu_evict_ctx_v1A_1C.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_GPU_EVICT_CTX_PARAMS_v03_00, 8),
])
...
struct_NV2080_CTRL_FB_FS_INFO_PROFILER_MON_LTC_MASK_PARAMS_v1A_1D.register_fields([
  ("fbpIndex", NvU32, 0),
  ("swizzId", NvU32, 4),
  ("ltcEnMask", NvU32, 8),
])
...
struct_NV2080_CTRL_FB_FS_INFO_PROFILER_MON_LTS_MASK_PARAMS_v1A_1D.register_fields([
  ("fbpIndex", NvU32, 0),
  ("swizzId", NvU32, 4),
  ("ltsEnMask", NvU32, 8),
])
...
struct_NV2080_CTRL_FB_FS_INFO_PROFILER_MON_FBPA_MASK_PARAMS_v1A_1D.register_fields([
  ("fbpIndex", NvU32, 0),
  ("swizzId", NvU32, 4),
  ("fbpaEnMask", NvU32, 8),
])
...
struct_NV2080_CTRL_FB_FS_INFO_PROFILER_MON_ROP_MASK_PARAMS_v1A_1D.register_fields([
  ("fbpIndex", NvU32, 0),
  ("swizzId", NvU32, 4),
  ("ropEnMask", NvU32, 8),
])
...
struct_NV2080_CTRL_FB_FS_INFO_PROFILER_MON_FBPA_SUBP_MASK_PARAMS_v1A_1D.register_fields([
  ("fbpIndex", NvU32, 0),
  ("swizzId", NvU32, 4),
  ("fbpaSubpEnMask", NvU64, 8),
])
...
union_NV2080_CTRL_FB_FS_INFO_QUERY_DATA_v1A_1D.register_fields([
  ("inv", NV2080_CTRL_FB_FS_INFO_INVALID_QUERY_PARAMS_v1A_1D, 0),
  ("fbp", NV2080_CTRL_FB_FS_INFO_FBP_MASK_PARAMS_v1A_1D, 0),
  ("ltc", NV2080_CTRL_FB_FS_INFO_LTC_MASK_PARAMS_v1A_1D, 0),
  ("lts", NV2080_CTRL_FB_FS_INFO_LTS_MASK_PARAMS_v1A_1D, 0),
  ("fbpa", NV2080_CTRL_FB_FS_INFO_FBPA_MASK_PARAMS_v1A_1D, 0),
  ("rop", NV2080_CTRL_FB_FS_INFO_ROP_MASK_PARAMS_v1A_1D, 0),
  ("dmLtc", NV2080_CTRL_FB_FS_INFO_PROFILER_MON_LTC_MASK_PARAMS_v1A_1D, 0),
  ("dmLts", NV2080_CTRL_FB_FS_INFO_PROFILER_MON_LTS_MASK_PARAMS_v1A_1D, 0),
  ("dmFbpa", NV2080_CTRL_FB_FS_INFO_PROFILER_MON_FBPA_MASK_PARAMS_v1A_1D, 0),
  ("dmRop", NV2080_CTRL_FB_FS_INFO_PROFILER_MON_ROP_MASK_PARAMS_v1A_1D, 0),
  ("dmFbpaSubp", NV2080_CTRL_FB_FS_INFO_PROFILER_MON_FBPA_SUBP_MASK_PARAMS_v1A_1D, 0),
  ("fbpaSubp", NV2080_CTRL_FB_FS_INFO_FBPA_SUBP_MASK_PARAMS_v1A_1D, 0),
  ("fbpLogicalMap", NV2080_CTRL_FB_FS_INFO_FBP_LOGICAL_MAP_PARAMS_v1A_1D, 0),
])
struct_NV2080_CTRL_FB_FS_INFO_QUERY_v1A_1D.register_fields([
  ("queryType", NvU16, 0),
  ("reserved", c.Array[NvU8, Literal[2]], 2),
  ("status", NvU32, 4),
  ("queryParams", NV2080_CTRL_FB_FS_INFO_QUERY_DATA_v1A_1D, 8),
])
struct_NV2080_CTRL_FB_GET_FS_INFO_PARAMS_v24_00.register_fields([
  ("numQueries", NvU16, 0),
  ("reserved", c.Array[NvU8, Literal[6]], 2),
  ("queries", c.Array[NV2080_CTRL_FB_FS_INFO_QUERY_v1A_1D, Literal[120]], 8),
])
struct_rpc_ctrl_fb_get_fs_info_v24_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_FB_GET_FS_INFO_PARAMS_v24_00, 8),
])
...
NV2080_CTRL_FB_FS_INFO_PROFILER_MON_LOGICAL_LTC_MASK_PARAMS_v26_04: TypeAlias = (
  struct_NV2080_CTRL_FB_FS_INFO_PROFILER_MON_LOGICAL_LTC_MASK_PARAMS_v26_04
)
struct_NV2080_CTRL_FB_FS_INFO_PROFILER_MON_LOGICAL_LTC_MASK_PARAMS_v26_04.register_fields([
  ("fbpIndex", NvU32, 0),
  ("swizzId", NvU32, 4),
  ("logicalLtcEnMask", NvU64, 8),
])
union_NV2080_CTRL_FB_FS_INFO_QUERY_DATA_v26_04.register_fields([
  ("inv", NV2080_CTRL_FB_FS_INFO_INVALID_QUERY_PARAMS_v1A_1D, 0),
  ("fbp", NV2080_CTRL_FB_FS_INFO_FBP_MASK_PARAMS_v1A_1D, 0),
  ("ltc", NV2080_CTRL_FB_FS_INFO_LTC_MASK_PARAMS_v1A_1D, 0),
  ("lts", NV2080_CTRL_FB_FS_INFO_LTS_MASK_PARAMS_v1A_1D, 0),
  ...
  ("fbpaSubp", NV2080_CTRL_FB_FS_INFO_FBPA_SUBP_MASK_PARAMS_v1A_1D, 0),
  ("fbpLogicalMap", NV2080_CTRL_FB_FS_INFO_FBP_LOGICAL_MAP_PARAMS_v1A_1D, 0),
  ("sysl2Ltc", NV2080_CTRL_SYSL2_FS_INFO_SYSLTC_MASK_PARAMS_v26_04, 0),
  ("pac", NV2080_CTRL_FB_FS_INFO_PAC_MASK_PARAMS_v26_04, 0),
  ("logicalLtc", NV2080_CTRL_FB_FS_INFO_LOGICAL_LTC_MASK_PARAMS_v26_04, 0),
  ("dmLogicalLtc", NV2080_CTRL_FB_FS_INFO_PROFILER_MON_LOGICAL_LTC_MASK_PARAMS_v26_04, 0),
])
struct_NV2080_CTRL_FB_FS_INFO_QUERY_v26_04.register_fields([
  ("queryType", NvU16, 0),
  ("reserved", c.Array[NvU8, Literal[2]], 2),
  ("status", NvU32, 4),
  ("queryParams", NV2080_CTRL_FB_FS_INFO_QUERY_DATA_v26_04, 8),
])
struct_NV2080_CTRL_FB_GET_FS_INFO_PARAMS_v26_04.register_fields([
  ("numQueries", NvU16, 0),
  ("reserved", c.Array[NvU8, Literal[6]], 2),
  ("queries", c.Array[NV2080_CTRL_FB_FS_INFO_QUERY_v26_04, Literal[120]], 8),
])
struct_rpc_ctrl_fb_get_fs_info_v26_04.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_FB_GET_FS_INFO_PARAMS_v26_04, 8),
])
...
NV2080_CTRL_GRMGR_GR_FS_INFO_PARTITION_CHIPLET_GPC_MAP_PARAMS_v1A_1D: TypeAlias = (
  struct_NV2080_CTRL_GRMGR_GR_FS_INFO_PARTITION_CHIPLET_GPC_MAP_PARAMS_v1A_1D
)
struct_NV2080_CTRL_GRMGR_GR_FS_INFO_PARTITION_CHIPLET_GPC_MAP_PARAMS_v1A_1D.register_fields([
  ("swizzId", NvU32, 0),
  ("gpcId", NvU32, 4),
  ("chipletGpcMap", NvU32, 8),
])
...
NV2080_CTRL_GRMGR_GR_FS_INFO_PARTITION_CHIPLET_SYSPIPE_IDS_PARAMS_v1A_1D: TypeAlias = (
  struct_NV2080_CTRL_GRMGR_GR_FS_INFO_PARTITION_CHIPLET_SYSPIPE_IDS_PARAMS_v1A_1D
)
struct_NV2080_CTRL_GRMGR_GR_FS_INFO_PARTITION_CHIPLET_SYSPIPE_IDS_PARAMS_v1A_1D.register_fields([
  ("swizzId", NvU16, 0),
  ("physSyspipeIdCount", NvU16, 2),
  ("physSyspipeId", c.Array[NvU8, Literal[8]], 4),
])
...
struct_NV2080_CTRL_GRMGR_GR_FS_INFO_PROFILER_MON_GPC_MASK_PARAMS_v1A_1D.register_fields([
  ("swizzId", NvU32, 0),
  ("grIdx", NvU32, 4),
  ("gpcEnMask", NvU32, 8),
])
...
union_NV2080_CTRL_GRMGR_GR_FS_INFO_QUERY_DATA_v1A_1D.register_fields([
  ("gpcCountData", NV2080_CTRL_GRMGR_GR_FS_INFO_GPC_COUNT_PARAMS_v1A_1D, 0),
  ("chipletGpcMapData", NV2080_CTRL_GRMGR_GR_FS_INFO_CHIPLET_GPC_MAP_PARAMS_v1A_1D, 0),
  ("tpcMaskData", NV2080_CTRL_GRMGR_GR_FS_INFO_TPC_MASK_PARAMS_v1A_1D, 0),
  ("ppcMaskData", NV2080_CTRL_GRMGR_GR_FS_INFO_PPC_MASK_PARAMS_v1A_1D, 0),
  ("partitionGpcMapData", NV2080_CTRL_GRMGR_GR_FS_INFO_PARTITION_CHIPLET_GPC_MAP_PARAMS_v1A_1D, 0),
  ("syspipeMaskData", NV2080_CTRL_GRMGR_GR_FS_INFO_CHIPLET_SYSPIPE_MASK_PARAMS_v1A_1D, 0),
  ("partitionChipletSyspipeData", NV2080_CTRL_GRMGR_GR_FS_INFO_PARTITION_CHIPLET_SYSPIPE_IDS_PARAMS_v1A_1D, 0),
  ("dmGpcMaskData", NV2080_CTRL_GRMGR_GR_FS_INFO_PROFILER_MON_GPC_MASK_PARAMS_v1A_1D, 0),
  ("partitionSyspipeIdData", NV2080_CTRL_GRMGR_GR_FS_INFO_PARTITION_SYSPIPE_ID_PARAMS_v1A_1D, 0),
  ("ropMaskData", NV2080_CTRL_GRMGR_GR_FS_INFO_ROP_MASK_PARAMS_v1A_1D, 0),
])
struct_NV2080_CTRL_GRMGR_GR_FS_INFO_QUERY_PARAMS_v1A_1D.register_fields([
  ("queryType", NvU16, 0),
  ("reserved", c.Array[NvU8, Literal[2]], 2),
  ("status", NvU32, 4),
  ("queryData", NV2080_CTRL_GRMGR_GR_FS_INFO_QUERY_DATA_v1A_1D, 8),
])
struct_NV2080_CTRL_GRMGR_GET_GR_FS_INFO_PARAMS_v1A_1D.register_fields([
  ("numQueries", NvU16, 0),
  ("reserved", c.Array[NvU8, Literal[6]], 2),
  ("queries", c.Array[NV2080_CTRL_GRMGR_GR_FS_INFO_QUERY_PARAMS_v1A_1D, Literal[96]], 8),
])
struct_rpc_ctrl_grmgr_get_gr_fs_info_v1A_1D.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_GRMGR_GET_GR_FS_INFO_PARAMS_v1A_1D, 8),
])
...
struct_rpc_ctrl_stop_channel_v1A_1E.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVA06F_CTRL_STOP_CHANNEL_PARAMS_v1A_1E, 8),
])
...
struct_NV2080_CTRL_GR_PC_SAMPLING_MODE_PARAMS_v1A_1F.register_fields([
  ("hChannel", NvHandle, 0),
  ("samplingMode", NvU32, 4),
  ("grRouteInfo", NV2080_CTRL_GR_ROUTE_INFO_v12_01, 8),
])
struct_rpc_ctrl_gr_pc_sampling_mode_v1A_1F.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_GR_PC_SAMPLING_MODE_PARAMS_v1A_1F, 8),
])
...
enum_NV2080_CTRL_PERF_RATED_TDP_ACTION: dict[int, str] = {
  (NV2080_CTRL_PERF_RATED_TDP_ACTION_DEFAULT := 0): "NV2080_CTRL_PERF_RATED_TDP_ACTION_DEFAULT",
  (NV2080_CTRL_PERF_RATED_TDP_ACTION_FORCE_EXCEED := 1): "NV2080_CTRL_PERF_RATED_TDP_ACTION_FORCE_EXCEED",
  (NV2080_CTRL_PERF_RATED_TDP_ACTION_FORCE_LIMIT := 2): "NV2080_CTRL_PERF_RATED_TDP_ACTION_FORCE_LIMIT",
  (NV2080_CTRL_PERF_RATED_TDP_ACTION_FORCE_LOCK := 3): "NV2080_CTRL_PERF_RATED_TDP_ACTION_FORCE_LOCK",
  (NV2080_CTRL_PERF_RATED_TDP_ACTION_FORCE_FLOOR := 4): "NV2080_CTRL_PERF_RATED_TDP_ACTION_FORCE_FLOOR",
}
NV2080_CTRL_PERF_RATED_TDP_ACTION: TypeAlias = ctypes.c_uint32
struct_NV2080_CTRL_PERF_RATED_TDP_STATUS_PARAMS_v1A_1F.register_fields([
  ("rm", PERF_RATED_TDP_RM_INTERNAL_STATE_STRUCT_v1A_1F, 0),
  ("output", NV2080_CTRL_PERF_RATED_TDP_ACTION, 8),
  ("inputs", c.Array[NV2080_CTRL_PERF_RATED_TDP_ACTION, Literal[5]], 12),
])
struct_rpc_ctrl_perf_rated_tdp_get_status_v1A_1F.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_PERF_RATED_TDP_STATUS_PARAMS_v1A_1F, 8),
])
...
enum_NV2080_CTRL_PERF_RATED_TDP_CLIENT: dict[int, str] = {
  (NV2080_CTRL_PERF_RATED_TDP_CLIENT_RM := 0): "NV2080_CTRL_PERF_RATED_TDP_CLIENT_RM",
  (NV2080_CTRL_PERF_RATED_TDP_CLIENT_WAR_BUG_1785342 := 1): "NV2080_CTRL_PERF_RATED_TDP_CLIENT_WAR_BUG_1785342",
  (NV2080_CTRL_PERF_RATED_TDP_CLIENT_GLOBAL := 2): "NV2080_CTRL_PERF_RATED_TDP_CLIENT_GLOBAL",
  (NV2080_CTRL_PERF_RATED_TDP_CLIENT_OS := 3): "NV2080_CTRL_PERF_RATED_TDP_CLIENT_OS",
  (NV2080_CTRL_PERF_RATED_TDP_CLIENT_PROFILE := 4): "NV2080_CTRL_PERF_RATED_TDP_CLIENT_PROFILE",
  (NV2080_CTRL_PERF_RATED_TDP_CLIENT_NUM_CLIENTS := 5): "NV2080_CTRL_PERF_RATED_TDP_CLIENT_NUM_CLIENTS",
}
NV2080_CTRL_PERF_RATED_TDP_CLIENT: TypeAlias = ctypes.c_uint32
struct_NV2080_CTRL_PERF_RATED_TDP_CONTROL_PARAMS_v1A_1F.register_fields([
  ("client", NV2080_CTRL_PERF_RATED_TDP_CLIENT, 0),
  ("input", NV2080_CTRL_PERF_RATED_TDP_ACTION, 4),
])
struct_rpc_ctrl_perf_rated_tdp_set_control_v1A_1F.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_PERF_RATED_TDP_CONTROL_PARAMS_v1A_1F, 8),
])
...
struct_rpc_ctrl_timer_set_gr_tick_freq_v1A_1F.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_CMD_TIMER_SET_GR_TICK_FREQ_PARAMS_v1A_1F, 8),
])
...
struct_rpc_ctrl_free_pma_stream_v1A_1F.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_FREE_PMA_STREAM_PARAMS_v1A_1F, 8),
])
...
struct_NV2080_CTRL_FIFO_SETUP_VF_ZOMBIE_SUBCTX_PDB_PARAMS_v1A_23.register_fields([
  ("base", NvU64, 0),
  ("size", NvU64, 8),
  ("addressSpace", NvU32, 16),
  ("cacheAttrib", NvU32, 20),
])
struct_rpc_ctrl_fifo_setup_vf_zombie_subctx_pdb_v1A_23.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_FIFO_SETUP_VF_ZOMBIE_SUBCTX_PDB_PARAMS_v1A_23, 8),
])
...
struct_rpc_ctrl_dbg_set_single_sm_single_step_v1C_02.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV83DE_CTRL_DEBUG_SET_SINGLE_SM_SINGLE_STEP_PARAMS_v1C_02, 8),
])
...
enum_NV0080_CTRL_GR_TPC_PARTITION_MODE: dict[int, str] = {
  (NV0080_CTRL_GR_TPC_PARTITION_MODE_NONE := 0): "NV0080_CTRL_GR_TPC_PARTITION_MODE_NONE",
  (NV0080_CTRL_GR_TPC_PARTITION_MODE_STATIC := 1): "NV0080_CTRL_GR_TPC_PARTITION_MODE_STATIC",
...
struct_NV0080_CTRL_GR_TPC_PARTITION_MODE_PARAMS_v1C_04.register_fields([
  ("hChannelGroup", NvHandle, 0),
  ("mode", NV0080_CTRL_GR_TPC_PARTITION_MODE, 4),
  ("bEnableAllTpcs", NvBool, 8),
  ("grRouteInfo", NV2080_CTRL_GR_ROUTE_INFO_v12_01, 16),
])
struct_rpc_ctrl_gr_get_tpc_partition_mode_v1C_04.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV0080_CTRL_GR_TPC_PARTITION_MODE_PARAMS_v1C_04, 8),
])
...
struct_rpc_ctrl_gr_set_tpc_partition_mode_v1C_04.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV0080_CTRL_GR_TPC_PARTITION_MODE_PARAMS_v1C_04, 8),
])
...
struct_NV2080_CTRL_INTERNAL_MEMDESC_INFO_v1E_07.register_fields([
  ("base", NvU64, 0),
  ("size", NvU64, 8),
  ("alignment", NvU64, 16),
  ("addressSpace", NvU32, 24),
  ("cpuCacheAttrib", NvU32, 28),
])
struct_NVA06C_CTRL_INTERNAL_PROMOTE_FAULT_METHOD_BUFFERS_PARAMS_v1E_07.register_fields([
  ("methodBufferMemdesc", c.Array[NV2080_CTRL_INTERNAL_MEMDESC_INFO_v1E_07, Literal[2]], 0),
  ("bar2Addr", c.Array[NvU64, Literal[2]], 64),
  ("numValidEntries", NvU32, 80),
])
struct_rpc_ctrl_internal_promote_fault_method_buffers_v1E_07.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVA06C_CTRL_INTERNAL_PROMOTE_FAULT_METHOD_BUFFERS_PARAMS_v1E_07, 8),
])
...
struct_rpc_ctrl_internal_memsys_set_zbc_referenced_v1F_05.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_CMD_INTERNAL_MEMSYS_SET_ZBC_REFERENCED_v1F_05, 8),
])
...
struct_NV00F8_CTRL_DESCRIBE_PARAMS_v1E_0C.register_fields([
  ("offset", NvU64, 0),
  ("totalPfns", NvU64, 8),
  ("pfnArray", c.Array[NvU32, Literal[512]], 16),
  ("numPfns", NvU32, 2064),
])
struct_rpc_ctrl_fabric_memory_describe_v1E_0C.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV00F8_CTRL_DESCRIBE_PARAMS_v1E_0C, 8),
])
...
struct_rpc_ctrl_fabric_mem_stats_v1E_0C.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_FLA_GET_FABRIC_MEM_STATS_PARAMS_v1E_0C, 8),
])
...
struct_NV2080_CTRL_BUS_SET_P2P_MAPPING_PARAMS_v21_03.register_fields([
  ("connectionType", NvU32, 0),
  ("peerId", NvU32, 4),
  ("bSpaAccessOnly", NvU32, 8),
  ("bUseUuid", NvBool, 12),
  ("remoteGpuId", NvU32, 16),
  ("remoteGpuUuid", c.Array[NvU8, Literal[16]], 20),
])
struct_rpc_ctrl_bus_set_p2p_mapping_v21_03.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_BUS_SET_P2P_MAPPING_PARAMS_v21_03, 8),
])
...
struct_NV2080_CTRL_BUS_SET_P2P_MAPPING_PARAMS_v29_08.register_fields([
  ("connectionType", NvU32, 0),
  ("peerId", NvU32, 4),
  ("bEgmPeer", NvBool, 8),
  ("bSpaAccessOnly", NvU32, 12),
  ("bUseUuid", NvBool, 16),
  ("remoteGpuId", NvU32, 20),
  ("remoteGpuUuid", c.Array[NvU8, Literal[16]], 24),
])
struct_rpc_ctrl_bus_set_p2p_mapping_v29_08.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_BUS_SET_P2P_MAPPING_PARAMS_v29_08, 8),
])
...
struct_NV2080_CTRL_BUS_UNSET_P2P_MAPPING_PARAMS_v21_03.register_fields([
  ("connectionType", NvU32, 0),
  ("peerId", NvU32, 4),
  ("bUseUuid", NvBool, 8),
  ("remoteGpuId", NvU32, 12),
  ("remoteGpuUuid", c.Array[NvU8, Literal[16]], 16),
])
struct_rpc_ctrl_bus_unset_p2p_mapping_v21_03.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_BUS_UNSET_P2P_MAPPING_PARAMS_v21_03, 8),
])
...
struct_NV2080_CTRL_GPU_GET_INFO_V2_PARAMS_v25_11.register_fields([
  ("gpuInfoListSize", NvU32, 0),
  ("gpuInfoList", c.Array[NV2080_CTRL_GPU_INFO_v25_11, Literal[65]], 4),
])
struct_rpc_ctrl_gpu_get_info_v2_v25_11.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_GPU_GET_INFO_V2_PARAMS_v25_11, 8),
])
...
struct_rpc_update_gpm_guest_buffer_info_v27_01.register_fields([
  ("gpfn", NvU64, 0),
  ("swizzId", NvU32, 8),
  ("computeId", NvU32, 12),
  ("bufSize", NvU32, 16),
...
struct_rpc_ctrl_internal_quiesce_pma_channel_v1C_08.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_INTERNAL_QUIESCE_PMA_CHANNEL_PARAMS_v1C_08, 8),
])
...
struct_NVB0CC_CTRL_INTERNAL_SRIOV_PROMOTE_PMA_STREAM_PARAMS_v1C_0C.register_fields([
  ("pmaChannelIdx", NvU32, 0),
  ("pmaBufferVA", NvU64, 8),
  ("pmaBufferSize", NvU64, 16),
  ("membytesVA", NvU64, 24),
  ("hwpmIBPA", NvU64, 32),
  ("hwpmIBAperture", NvU8, 40),
])
struct_rpc_ctrl_internal_sriov_promote_pma_stream_v1C_0C.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_INTERNAL_SRIOV_PROMOTE_PMA_STREAM_PARAMS_v1C_0C, 8),
])
...
struct_NVC637_CTRL_EXEC_PARTITIONS_INFO_v24_05.register_fields([
  ("gpcCount", NvU32, 0),
  ("gfxGpcCount", NvU32, 4),
  ("veidCount", NvU32, 8),
  ("ceCount", NvU32, 12),
  ...
  ("nvJpgCount", NvU32, 24),
  ("ofaCount", NvU32, 28),
  ("sharedEngFlag", NvU32, 32),
  ("smCount", NvU32, 36),
  ("spanStart", NvU32, 40),
  ("computeSize", NvU32, 44),
])
struct_NVC637_CTRL_EXEC_PARTITIONS_CREATE_PARAMS_v24_05.register_fields([
  ("bQuery", NvBool, 0),
  ("execPartCount", NvU32, 4),
  ("execPartInfo", c.Array[NVC637_CTRL_EXEC_PARTITIONS_INFO_v24_05, Literal[8]], 8),
  ("execPartId", c.Array[NvU32, Literal[8]], 392),
])
struct_rpc_ctrl_exec_partitions_create_v24_05.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("status", NvU32, 8),
  ("execPartitionsCreate", NVC637_CTRL_EXEC_PARTITIONS_CREATE_PARAMS_v24_05, 12),
])
...
struct_NV2080_CTRL_FLA_SETUP_INSTANCE_MEM_BLOCK_PARAMS_v13_04.register_fields([
  ("imbPhysAddr", NvU64, 0),
  ("addrSpace", NvU32, 8),
  ("flaAction", NvU32, 12),
])
struct_rpc_ctrl_fla_setup_instance_mem_block_v21_05.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_FLA_SETUP_INSTANCE_MEM_BLOCK_PARAMS_v13_04, 8),
])
...
struct_rpc_ctrl_get_total_hs_credits_v21_08.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_GET_TOTAL_HS_CREDITS_PARAMS_v21_08, 8),
])
...
struct_NVB0CC_CTRL_GET_HS_CREDITS_PARAMS_v21_08.register_fields([
  ("pmaChannelIdx", NvU8, 0),
  ("numEntries", NvU8, 1),
  ("statusInfo", NVB0CC_CTRL_PMA_STREAM_HS_CREDITS_STATUS_v21_08, 2),
  ("creditInfo", c.Array[NVB0CC_CTRL_PMA_STREAM_HS_CREDITS_INFO_v21_08, Literal[63]], 4),
])
struct_rpc_ctrl_get_hs_credits_v21_08.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_GET_HS_CREDITS_PARAMS_v21_08, 8),
])
...
struct_rpc_ctrl_reserve_hes_v29_07.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_RESERVE_HES_PARAMS_v29_07, 8),
])
...
struct_rpc_ctrl_release_hes_v29_07.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_RELEASE_HES_PARAMS_v29_07, 8),
])
...
struct_rpc_ctrl_reserve_ccu_prof_v29_07.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_RESERVE_CCUPROF_PARAMS_v29_07, 8),
])
...
struct_NVB0CC_CTRL_SET_HS_CREDITS_PARAMS_v21_08.register_fields([
  ("pmaChannelIdx", NvU8, 0),
  ("numEntries", NvU8, 1),
  ("statusInfo", NVB0CC_CTRL_PMA_STREAM_HS_CREDITS_STATUS_v21_08, 2),
  ("creditInfo", c.Array[NVB0CC_CTRL_PMA_STREAM_HS_CREDITS_INFO_v21_08, Literal[63]], 4),
])
struct_rpc_ctrl_set_hs_credits_v21_08.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NVB0CC_CTRL_SET_HS_CREDITS_PARAMS_v21_08, 8),
])
...
struct_rpc_ctrl_exec_partitions_delete_v1F_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("execPartitionsDelete", NVC637_CTRL_EXEC_PARTITIONS_DELETE_PARAMS_v18_05, 8),
])
...
struct_rpc_ctrl_gpfifo_get_work_submit_token_v1F_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("workSubmitToken", NVC36F_CTRL_CMD_GPFIFO_GET_WORK_SUBMIT_TOKEN_PARAMS_v08_00, 8),
])
...
NVC36F_CTRL_GPFIFO_SET_WORK_SUBMIT_TOKEN_NOTIF_INDEX_PARAMS_v16_04: TypeAlias = (
...
struct_rpc_ctrl_gpfifo_set_work_submit_token_notif_index_v1F_0A.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("setWorkSubmitTokenIndex", NVC36F_CTRL_GPFIFO_SET_WORK_SUBMIT_TOKEN_NOTIF_INDEX_PARAMS_v16_04, 8),
])
...
NV90E6_CTRL_MASTER_GET_VIRTUAL_FUNCTION_ERROR_CONT_INTR_MASK_PARAMS_v18_0B: TypeAlias = (
...
struct_rpc_ctrl_master_get_virtual_function_error_cont_intr_mask_v1F_0D.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("vfErrContIntrMask", NV90E6_CTRL_MASTER_GET_VIRTUAL_FUNCTION_ERROR_CONT_INTR_MASK_PARAMS_v18_0B, 8),
])
...
struct_rpc_ctrl_get_mmu_debug_mode_v1E_06.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV0090_CTRL_GET_MMU_DEBUG_MODE_PARAMS_v1E_06, 8),
])
...
struct_NV2080_CTRL_GPU_MIGRATABLE_OPS_PARAMS_v21_07.register_fields([
  ("hClientTarget", NvHandle, 0),
  ("hChannelTarget", NvHandle, 4),
  ("bNonTransactional", NvU32, 8),
  ("regOpCount", NvU32, 12),
  ("smIds", c.Array[NvU32, Literal[50]], 16),
  ("regOps", c.Array[NV2080_CTRL_GPU_REG_OP_v03_00, Literal[50]], 216),
  ("grRouteInfo", NV2080_CTRL_GR_ROUTE_INFO_v12_01, 1816),
])
struct_rpc_ctrl_gpu_migratable_ops_v21_07.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_GPU_MIGRATABLE_OPS_PARAMS_v21_07, 8),
])
...
struct_rpc_gsp_rm_alloc_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hParent", NvHandle, 4),
  ("hObject", NvHandle, 8),
  ("hClass", NvU32, 12),
  ...
  ("paramsSize", NvU32, 20),
  ("flags", NvU32, 24),
  ("reserved", c.Array[NvU8, Literal[4]], 28),
  ("params", c.Array[NvU8, Literal[0]], 32),
])
...
struct_rpc_gsp_rm_control_v03_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("cmd", NvU32, 8),
  ("status", NvU32, 12),
  ("paramsSize", NvU32, 16),
  ("flags", NvU32, 20),
  ("params", c.Array[NvU8, Literal[0]], 24),
])
...
struct_rpc_dump_protobuf_component_v18_12.register_fields([
  ("component", NvU16, 0),
  ("nvDumpType", NvU8, 2),
  ("countOnly", NvBool, 3),
  ("bugCheckCode", NvU32, 4),
  ("internalCode", NvU32, 8),
  ("bufferSize", NvU32, 12),
  ("blob", c.Array[NvU8, Literal[0]], 16),
])
...
struct_rpc_run_cpu_sequencer_v17_00.register_fields([
  ("bufferSizeDWord", NvU32, 0),
  ("cmdIndex", NvU32, 4),
  ("regSaveArea", c.Array[NvU32, Literal[8]], 8),
  ("commandBuffer", c.Array[NvU32, Literal[0]], 40),
])
...
struct_rpc_post_event_v17_00.register_fields([
  ("hClient", NvHandle, 0),
  ("hEvent", NvHandle, 4),
  ("notifyIndex", NvU32, 8),
  ("data", NvU32, 12),
  ("info16", NvU16, 16),
  ("status", NvU32, 20),
  ("eventDataSize", NvU32, 24),
  ("bNotifyList", NvBool, 28),
  ("eventData", c.Array[NvU8, Literal[0]], 29),
])
...
struct_rpc_rc_triggered_v17_02.register_fields([
  ("nv2080EngineType", NvU32, 0),
  ("chid", NvU32, 4),
  ("gfid", NvU32, 8),
  ("exceptLevel", NvU32, 12),
  ("exceptType", NvU32, 16),
  ("scope", NvU32, 20),
  ("partitionAttributionId", NvU16, 24),
  ("mmuFaultAddrLo", NvU32, 28),
  ("mmuFaultAddrHi", NvU32, 32),
  ("mmuFaultType", NvU32, 36),
  ("bCallbackNeeded", NvBool, 40),
  ("rcJournalBufferSize", NvU32, 44),
  ("rcJournalBuffer", c.Array[NvU8, Literal[0]], 48),
])
...
struct_rpc_os_error_log_v17_00.register_fields([
  ("exceptType", NvU32, 0),
  ("runlistId", NvU32, 4),
  ("chid", NvU32, 8),
  ("errString", c.Array[ctypes.c_char, Literal[256]], 12),
])
...
struct_rpc_display_modeset_v01_00.register_fields([
  ("bModesetStart", NvBool, 0),
  ("minRequiredIsoBandwidthKBPS", NvU32, 4),
  ("minRequiredFloorBandwidthKBPS", NvU32, 8),
])
...
NV2080_CTRL_PERF_GET_GPUMON_PERFMON_UTIL_SAMPLES_V2_PARAMS_v1F_0E: TypeAlias = (
  struct_NV2080_CTRL_PERF_GET_GPUMON_PERFMON_UTIL_SAMPLES_V2_PARAMS_v1F_0E
)
struct_NV2080_CTRL_PERF_GET_GPUMON_PERFMON_UTIL_SAMPLES_V2_PARAMS_v1F_0E.register_fields([
  ("type", NvU8, 0),
  ("bufSize", NvU32, 4),
  ("count", NvU32, 8),
  ("tracker", NvU32, 12),
  ("samples", c.Array[NV2080_CTRL_PERF_GPUMON_PERFMON_UTIL_SAMPLE_v1F_0E, Literal[72]], 16),
])
...
struct_rpc_sim_write_v1E_01.register_fields([
  ("path", c.Array[ctypes.c_char, Literal[256]], 0),
  ("index", NvU32, 256),
  ("count", NvU32, 260),
  ("data", NvU32, 264),
])
...
struct_rpc_ucode_libos_print_v1E_08.register_fields([
  ("ucodeEngDesc", NvU32, 0),
  ("libosPrintBufSize", NvU32, 4),
  ("libosPrintBuf", c.Array[NvU8, Literal[0]], 8),
])
...
struct_rpc_semaphore_schedule_callback_v17_00.register_fields([
  ("GPUVA", NvU64, 0),
  ("hVASpace", NvU32, 8),
  ("ReleaseValue", NvU32, 12),
  ("Flags", NvU32, 16),
  ("completionStatus", NvU32, 20),
  ("hClient", NvHandle, 24),
  ("hEvent", NvHandle, 28),
])
...
struct_rpc_timed_semaphore_release_v01_00.register_fields([
  ("semaphoreVA", NvU64, 0),
  ("notifierVA", NvU64, 8),
  ("hVASpace", NvU32, 16),
  ("releaseValue", NvU32, 20),
  ("completionStatus", NvU32, 24),
  ("hClient", NvHandle, 28),
  ("hDevice", NvHandle, 32),
])
...
NV2080_CTRL_INTERNAL_PERF_GPU_BOOST_SYNC_SET_LIMITS_PARAMS_v17_00: TypeAlias = (
  struct_NV2080_CTRL_INTERNAL_PERF_GPU_BOOST_SYNC_SET_LIMITS_PARAMS_v17_00
)
struct_NV2080_CTRL_INTERNAL_PERF_GPU_BOOST_SYNC_SET_LIMITS_PARAMS_v17_00.register_fields([
  ("flags", NvU32, 0),
  ("bBridgeless", NvBool, 4),
  ("currLimits", c.Array[NvU32, Literal[2]], 8),
])
struct_rpc_perf_gpu_boost_sync_limits_callback_v17_00.register_fields([
  ("params", NV2080_CTRL_INTERNAL_PERF_GPU_BOOST_SYNC_SET_LIMITS_PARAMS_v17_00, 0)
])
...
struct_rpc_extdev_intr_service_v17_00.register_fields([
  ("lossRegStatus", NvU8, 0),
  ("gainRegStatus", NvU8, 1),
  ("miscRegStatus", NvU8, 2),
  ("rmStatus", NvBool, 3),
])
...
union_NV2080_CTRL_INTERNAL_PFM_REQ_HNDLR_STATE_SYNC_DATA_type_v21_04.register_fields([
  ("smbpbi", NV2080_CTRL_INTERNAL_PFM_REQ_HNDLR_STATE_SYNC_DATA_SMBPBI_v21_04, 0)
])
struct_NV2080_CTRL_INTERNAL_PFM_REQ_HNDLR_STATE_SYNC_data_v21_04.register_fields([
  ("type", NvU8, 0),
  ("data", NV2080_CTRL_INTERNAL_PFM_REQ_HNDLR_STATE_SYNC_DATA_type_v21_04, 4),
])
struct_NV2080_CTRL_INTERNAL_PFM_REQ_HNDLR_STATE_SYNC_PARAMS_v21_04.register_fields([
  ("flags", NvU8, 0),
  ("syncData", NV2080_CTRL_INTERNAL_PFM_REQ_HNDLR_STATE_SYNC_data_v21_04, 4),
])
...
struct_rpc_vgpu_gsp_mig_ci_config_v21_03.register_fields([
  ("execPartCount", NvU32, 0),
  ("execPartId", c.Array[NvU32, Literal[8]], 4),
  ("gfid", NvU32, 36),
  ("bDelete", NvBool, 40),
])
...
struct_NV2080_CTRL_GPU_QUERY_ECC_UNIT_STATUS_v15_01.register_fields([
  ("enabled", NvBool, 0),
  ("scrubComplete", NvBool, 1),
  ("supported", NvBool, 2),
  ("dbe", NV2080_CTRL_GPU_QUERY_ECC_EXCEPTION_STATUS_v15_01, 8),
  ("dbeNonResettable", NV2080_CTRL_GPU_QUERY_ECC_EXCEPTION_STATUS_v15_01, 16),
  ("sbe", NV2080_CTRL_GPU_QUERY_ECC_EXCEPTION_STATUS_v15_01, 24),
  ("sbeNonResettable", NV2080_CTRL_GPU_QUERY_ECC_EXCEPTION_STATUS_v15_01, 32),
])
struct_NV2080_CTRL_GPU_QUERY_ECC_STATUS_DEPRECATED_RPC_PARAMS_v24_06.register_fields([
  ("units", c.Array[NV2080_CTRL_GPU_QUERY_ECC_UNIT_STATUS_v15_01, Literal[25]], 0),
  ("bFatalPoisonError", NvBool, 1000),
  ("flags", NvU32, 1004),
])
struct_rpc_ctrl_gpu_query_ecc_status_v24_06.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_GPU_QUERY_ECC_STATUS_DEPRECATED_RPC_PARAMS_v24_06, 8),
])
...
struct_NV2080_CTRL_GPU_QUERY_ECC_STATUS_PARAMS_v26_02.register_fields([
  ("units", c.Array[NV2080_CTRL_GPU_QUERY_ECC_UNIT_STATUS_v15_01, Literal[30]], 0),
  ("bFatalPoisonError", NvBool, 1200),
  ("flags", NvU32, 1204),
])
struct_rpc_ctrl_gpu_query_ecc_status_v26_02.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("params", NV2080_CTRL_GPU_QUERY_ECC_STATUS_PARAMS_v26_02, 8),
])
...
struct_rpc_ctrl_dbg_get_mode_mmu_debug_v25_04.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_GET_MODE_MMU_DEBUG_PARAMS_v25_04, 8),
])
...
struct_rpc_ctrl_dbg_get_mode_mmu_gcc_debug_v29_07.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV83DE_CTRL_DEBUG_GET_MODE_MMU_GCC_DEBUG_PARAMS_v29_07, 8),
])
...
struct_rpc_ctrl_nvlink_get_inband_received_data_v25_0C.register_fields([
  ("message_type", NvU16, 0),
  ("more", NvBool, 2),
  ("payload", NV2080_CTRL_NVLINK_INBAND_RECEIVED_DATA_PARAMS_v25_0C, 4),
])
...
struct_rpc_ctrl_cmd_internal_control_gsp_trace_v28_00.register_fields([
  ("bufferSize", NvU32, 0),
  ("tracepointMask", NvU32, 4),
  ("bufferWatermark", NvU32, 8),
  ("bufferAddr", NvU64, 16),
  ("flag", NvU8, 24),
])
...
struct_NV2080_CTRL_CMD_GSP_GET_LIBOS_HEAP_STATS_PARAMS_v29_02.register_fields([
  ("poolStats", c.Array[NV2080_CTRL_GSP_LIBOS_POOL_STATS_v29_02, Literal[64]], 0),
  ("totalHeapSize", NvU64, 1024),
  ("poolCount", NvU8, 1032),
])
struct_rpc_ctrl_subdevice_get_libos_heap_stats_v29_02.register_fields([
  ("hClient", NvHandle, 0),
  ("hObject", NvHandle, 4),
  ("ctrlParams", NV2080_CTRL_CMD_GSP_GET_LIBOS_HEAP_STATS_PARAMS_v29_02, 8),
])
...
struct_GSP_MSG_QUEUE_ELEMENT.register_fields([
  ("authTagBuffer", c.Array[NvU8, Literal[16]], 0),
  ("aadBuffer", c.Array[NvU8, Literal[16]], 16),
  ("checkSum", NvU32, 32),
  ("seqNum", NvU32, 36),
  ("elemCount", NvU32, 40),
  ("padding", NvU32, 44),
...
struct_rpc_message_header_v03_00.register_fields([
  ("header_version", NvU32, 0),
  ("signature", NvU32, 4),
  ("length", NvU32, 8),
  ("function", NvU32, 12),
  ("rpc_result", NvU32, 16),
  ("rpc_result_private", NvU32, 20),
  ("sequence", NvU32, 24),
  ("u", rpc_message_rpc_union_field_v, 28),
])
...
DISPMUXSTATE: dict[int, str] = {
  (dispMuxState_None := 0): "dispMuxState_None",
  (dispMuxState_IntegratedGPU := 1): "dispMuxState_IntegratedGPU",
  (dispMuxState_DiscreteGPU := 2): "dispMuxState_DiscreteGPU",
}
...
ACPI_DSM_CACHE.register_fields([
  ("suppFuncStatus", NvU32, 0),
  ("suppFuncs", c.Array[NvU8, Literal[8]], 4),
  ("suppFuncsLen", NvU32, 12),
  ("bArg3isInteger", NvBool, 16),
  ("callbackStatus", NvU32, 20),
  ("callback", NvU32, 24),
])
...
enum__ACPI_DSM_FUNCTION: dict[int, str] = {
  (ACPI_DSM_FUNCTION_NBSI := 0): "ACPI_DSM_FUNCTION_NBSI",
  (ACPI_DSM_FUNCTION_NVHG := 1): "ACPI_DSM_FUNCTION_NVHG",
  (ACPI_DSM_FUNCTION_MXM := 2): "ACPI_DSM_FUNCTION_MXM",
  (ACPI_DSM_FUNCTION_NBCI := 3): "ACPI_DSM_FUNCTION_NBCI",
  (ACPI_DSM_FUNCTION_NVOP := 4): "ACPI_DSM_FUNCTION_NVOP",
  (ACPI_DSM_FUNCTION_PCFG := 5): "ACPI_DSM_FUNCTION_PCFG",
  (ACPI_DSM_FUNCTION_GPS_2X := 6): "ACPI_DSM_FUNCTION_GPS_2X",
  (ACPI_DSM_FUNCTION_JT := 7): "ACPI_DSM_FUNCTION_JT",
  (ACPI_DSM_FUNCTION_PEX := 8): "ACPI_DSM_FUNCTION_PEX",
  (ACPI_DSM_FUNCTION_NVPCF_2X := 9): "ACPI_DSM_FUNCTION_NVPCF_2X",
  (ACPI_DSM_FUNCTION_GPS := 10): "ACPI_DSM_FUNCTION_GPS",
  (ACPI_DSM_FUNCTION_NVPCF := 11): "ACPI_DSM_FUNCTION_NVPCF",
  (ACPI_DSM_FUNCTION_COUNT := 12): "ACPI_DSM_FUNCTION_COUNT",
  (ACPI_DSM_FUNCTION_CURRENT := 13): "ACPI_DSM_FUNCTION_CURRENT",
  (ACPI_DSM_FUNCTION_INVALID := 255): "ACPI_DSM_FUNCTION_INVALID",
}
ACPI_DSM_FUNCTION: TypeAlias = ctypes.c_uint32
ACPI_DATA.register_fields([
  ("dsm", c.Array[ACPI_DSM_CACHE, Literal[12]], 0),
  ("dispStatusHotplugFunc", ACPI_DSM_FUNCTION, 336),
  ("dispStatusConfigFunc", ACPI_DSM_FUNCTION, 340),
  ("perfPostPowerStateFunc", ACPI_DSM_FUNCTION, 344),
  ("stereo3dStateActiveFunc", ACPI_DSM_FUNCTION, 348),
  ("dsmPlatCapsCache", c.Array[NvU32, Literal[12]], 352),
  ("MDTLFeatureSupport", NvU32, 400),
  ("dsmCurrentFunc", c.Array[ACPI_DSM_FUNCTION, Literal[8]], 404),
  ("dsmCurrentSubFunc", c.Array[NvU32, Literal[8]], 436),
  ("dsmCurrentFuncSupport", NvU32, 468),
])
...
struct_MUX_METHOD_DATA.register_fields([
  ("tableLen", NvU32, 0),
  ("acpiIdMuxModeTable", c.Array[MUX_METHOD_DATA_ELEMENT, Literal[16]], 4),
  ("acpiIdMuxPartTable", c.Array[MUX_METHOD_DATA_ELEMENT, Literal[16]], 196),
  ("acpiIdMuxStateTable", c.Array[MUX_METHOD_DATA_ELEMENT, Literal[16]], 388),
])
...
struct_ACPI_METHOD_DATA.register_fields([
  ("bValid", NvBool, 0),
  ("dodMethodData", DOD_METHOD_DATA, 4),
  ("jtMethodData", JT_METHOD_DATA, 76),
  ("muxMethodData", MUX_METHOD_DATA, 88),
  ("capsMethodData", CAPS_METHOD_DATA, 668),
])
ACPI_METHOD_DATA: TypeAlias = struct_ACPI_METHOD_DATA
RM_ENGINE_TYPE: dict[int, str] = {
  (RM_ENGINE_TYPE_NULL := 0): "RM_ENGINE_TYPE_NULL",
  (RM_ENGINE_TYPE_GR0 := 1): "RM_ENGINE_TYPE_GR0",
  (RM_ENGINE_TYPE_GR1 := 2): "RM_ENGINE_TYPE_GR1",
  (RM_ENGINE_TYPE_GR2 := 3): "RM_ENGINE_TYPE_GR2",
  (RM_ENGINE_TYPE_GR3 := 4): "RM_ENGINE_TYPE_GR3",
  (RM_ENGINE_TYPE_GR4 := 5): "RM_ENGINE_TYPE_GR4",
  (RM_ENGINE_TYPE_GR5 := 6): "RM_ENGINE_TYPE_GR5",
  (RM_ENGINE_TYPE_GR6 := 7): "RM_ENGINE_TYPE_GR6",
  (RM_ENGINE_TYPE_GR7 := 8): "RM_ENGINE_TYPE_GR7",
  (RM_ENGINE_TYPE_COPY0 := 9): "RM_ENGINE_TYPE_COPY0",
  (RM_ENGINE_TYPE_COPY1 := 10): "RM_ENGINE_TYPE_COPY1",
  (RM_ENGINE_TYPE_COPY2 := 11): "RM_ENGINE_TYPE_COPY2",
  (RM_ENGINE_TYPE_COPY3 := 12): "RM_ENGINE_TYPE_COPY3",
  (RM_ENGINE_TYPE_COPY4 := 13): "RM_ENGINE_TYPE_COPY4",
  (RM_ENGINE_TYPE_COPY5 := 14): "RM_ENGINE_TYPE_COPY5",
  (RM_ENGINE_TYPE_COPY6 := 15): "RM_ENGINE_TYPE_COPY6",
  (RM_ENGINE_TYPE_COPY7 := 16): "RM_ENGINE_TYPE_COPY7",
  (RM_ENGINE_TYPE_COPY8 := 17): "RM_ENGINE_TYPE_COPY8",
  (RM_ENGINE_TYPE_COPY9 := 18): "RM_ENGINE_TYPE_COPY9",
  (RM_ENGINE_TYPE_COPY10 := 19): "RM_ENGINE_TYPE_COPY10",
  (RM_ENGINE_TYPE_COPY11 := 20): "RM_ENGINE_TYPE_COPY11",
  (RM_ENGINE_TYPE_COPY12 := 21): "RM_ENGINE_TYPE_COPY12",
  (RM_ENGINE_TYPE_COPY13 := 22): "RM_ENGINE_TYPE_COPY13",
  (RM_ENGINE_TYPE_COPY14 := 23): "RM_ENGINE_TYPE_COPY14",
  (RM_ENGINE_TYPE_COPY15 := 24): "RM_ENGINE_TYPE_COPY15",
  (RM_ENGINE_TYPE_COPY16 := 25): "RM_ENGINE_TYPE_COPY16",
  (RM_ENGINE_TYPE_COPY17 := 26): "RM_ENGINE_TYPE_COPY17",
  (RM_ENGINE_TYPE_COPY18 := 27): "RM_ENGINE_TYPE_COPY18",
  (RM_ENGINE_TYPE_COPY19 := 28): "RM_ENGINE_TYPE_COPY19",
  (RM_ENGINE_TYPE_NVDEC0 := 29): "RM_ENGINE_TYPE_NVDEC0",
  (RM_ENGINE_TYPE_NVDEC1 := 30): "RM_ENGINE_TYPE_NVDEC1",
  (RM_ENGINE_TYPE_NVDEC2 := 31): "RM_ENGINE_TYPE_NVDEC2",
  (RM_ENGINE_TYPE_NVDEC3 := 32): "RM_ENGINE_TYPE_NVDEC3",
  (RM_ENGINE_TYPE_NVDEC4 := 33): "RM_ENGINE_TYPE_NVDEC4",
  (RM_ENGINE_TYPE_NVDEC5 := 34): "RM_ENGINE_TYPE_NVDEC5",
  (RM_ENGINE_TYPE_NVDEC6 := 35): "RM_ENGINE_TYPE_NVDEC6",
  (RM_ENGINE_TYPE_NVDEC7 := 36): "RM_ENGINE_TYPE_NVDEC7",
  (RM_ENGINE_TYPE_NVENC0 := 37): "RM_ENGINE_TYPE_NVENC0",
  (RM_ENGINE_TYPE_NVENC1 := 38): "RM_ENGINE_TYPE_NVENC1",
  (RM_ENGINE_TYPE_NVENC2 := 39): "RM_ENGINE_TYPE_NVENC2",
  (RM_ENGINE_TYPE_NVENC3 := 40): "RM_ENGINE_TYPE_NVENC3",
  (RM_ENGINE_TYPE_VP := 41): "RM_ENGINE_TYPE_VP",
  (RM_ENGINE_TYPE_ME := 42): "RM_ENGINE_TYPE_ME",
  (RM_ENGINE_TYPE_PPP := 43): "RM_ENGINE_TYPE_PPP",
  (RM_ENGINE_TYPE_MPEG := 44): "RM_ENGINE_TYPE_MPEG",
  (RM_ENGINE_TYPE_SW := 45): "RM_ENGINE_TYPE_SW",
  (RM_ENGINE_TYPE_TSEC := 46): "RM_ENGINE_TYPE_TSEC",
  (RM_ENGINE_TYPE_VIC := 47): "RM_ENGINE_TYPE_VIC",
  (RM_ENGINE_TYPE_MP := 48): "RM_ENGINE_TYPE_MP",
  (RM_ENGINE_TYPE_SEC2 := 49): "RM_ENGINE_TYPE_SEC2",
  (RM_ENGINE_TYPE_HOST := 50): "RM_ENGINE_TYPE_HOST",
  (RM_ENGINE_TYPE_DPU := 51): "RM_ENGINE_TYPE_DPU",
  (RM_ENGINE_TYPE_PMU := 52): "RM_ENGINE_TYPE_PMU",
  (RM_ENGINE_TYPE_FBFLCN := 53): "RM_ENGINE_TYPE_FBFLCN",
  (RM_ENGINE_TYPE_NVJPEG0 := 54): "RM_ENGINE_TYPE_NVJPEG0",
  (RM_ENGINE_TYPE_NVJPEG1 := 55): "RM_ENGINE_TYPE_NVJPEG1",
  (RM_ENGINE_TYPE_NVJPEG2 := 56): "RM_ENGINE_TYPE_NVJPEG2",
  (RM_ENGINE_TYPE_NVJPEG3 := 57): "RM_ENGINE_TYPE_NVJPEG3",
  (RM_ENGINE_TYPE_NVJPEG4 := 58): "RM_ENGINE_TYPE_NVJPEG4",
  (RM_ENGINE_TYPE_NVJPEG5 := 59): "RM_ENGINE_TYPE_NVJPEG5",
  (RM_ENGINE_TYPE_NVJPEG6 := 60): "RM_ENGINE_TYPE_NVJPEG6",
  (RM_ENGINE_TYPE_NVJPEG7 := 61): "RM_ENGINE_TYPE_NVJPEG7",
  (RM_ENGINE_TYPE_OFA0 := 62): "RM_ENGINE_TYPE_OFA0",
  (RM_ENGINE_TYPE_OFA1 := 63): "RM_ENGINE_TYPE_OFA1",
  (RM_ENGINE_TYPE_RESERVED40 := 64): "RM_ENGINE_TYPE_RESERVED40",
  (RM_ENGINE_TYPE_RESERVED41 := 65): "RM_ENGINE_TYPE_RESERVED41",
  (RM_ENGINE_TYPE_RESERVED42 := 66): "RM_ENGINE_TYPE_RESERVED42",
  (RM_ENGINE_TYPE_RESERVED43 := 67): "RM_ENGINE_TYPE_RESERVED43",
  (RM_ENGINE_TYPE_RESERVED44 := 68): "RM_ENGINE_TYPE_RESERVED44",
  (RM_ENGINE_TYPE_RESERVED45 := 69): "RM_ENGINE_TYPE_RESERVED45",
  (RM_ENGINE_TYPE_RESERVED46 := 70): "RM_ENGINE_TYPE_RESERVED46",
  (RM_ENGINE_TYPE_RESERVED47 := 71): "RM_ENGINE_TYPE_RESERVED47",
  (RM_ENGINE_TYPE_RESERVED48 := 72): "RM_ENGINE_TYPE_RESERVED48",
  (RM_ENGINE_TYPE_RESERVED49 := 73): "RM_ENGINE_TYPE_RESERVED49",
  (RM_ENGINE_TYPE_RESERVED4a := 74): "RM_ENGINE_TYPE_RESERVED4a",
  (RM_ENGINE_TYPE_RESERVED4b := 75): "RM_ENGINE_TYPE_RESERVED4b",
  (RM_ENGINE_TYPE_RESERVED4c := 76): "RM_ENGINE_TYPE_RESERVED4c",
  (RM_ENGINE_TYPE_RESERVED4d := 77): "RM_ENGINE_TYPE_RESERVED4d",
  (RM_ENGINE_TYPE_RESERVED4e := 78): "RM_ENGINE_TYPE_RESERVED4e",
  (RM_ENGINE_TYPE_RESERVED4f := 79): "RM_ENGINE_TYPE_RESERVED4f",
  (RM_ENGINE_TYPE_RESERVED50 := 80): "RM_ENGINE_TYPE_RESERVED50",
  (RM_ENGINE_TYPE_RESERVED51 := 81): "RM_ENGINE_TYPE_RESERVED51",
  (RM_ENGINE_TYPE_RESERVED52 := 82): "RM_ENGINE_TYPE_RESERVED52",
  (RM_ENGINE_TYPE_RESERVED53 := 83): "RM_ENGINE_TYPE_RESERVED53",
  (RM_ENGINE_TYPE_LAST := 84): "RM_ENGINE_TYPE_LAST",
}
...
struct_GSP_VF_INFO.register_fields([
  ("totalVFs", NvU32, 0),
  ("firstVFOffset", NvU32, 4),
  ("FirstVFBar0Address", NvU64, 8),
  ("FirstVFBar1Address", NvU64, 16),
  ("FirstVFBar2Address", NvU64, 24),
  ("b64bitBar0", NvBool, 32),
  ("b64bitBar1", NvBool, 33),
  ("b64bitBar2", NvBool, 34),
])
...
struct_NV2080_CTRL_GPU_GET_GID_INFO_PARAMS.register_fields([
  ("index", NvU32, 0),
  ("flags", NvU32, 4),
  ("length", NvU32, 8),
  ("data", c.Array[NvU8, Literal[256]], 12),
])
...
struct_NV2080_CTRL_BIOS_GET_SKU_INFO_PARAMS.register_fields([
  ("BoardID", NvU32, 0),
  ("chipSKU", c.Array[ctypes.c_char, Literal[9]], 4),
  ("chipSKUMod", c.Array[ctypes.c_char, Literal[5]], 13),
  ("skuConfigVersion", NvU32, 20),
  ("project", c.Array[ctypes.c_char, Literal[5]], 24),
  ("projectSKU", c.Array[ctypes.c_char, Literal[5]], 29),
  ("CDP", c.Array[ctypes.c_char, Literal[6]], 34),
  ("projectSKUMod", c.Array[ctypes.c_char, Literal[2]], 40),
  ("businessCycle", NvU32, 44),
])
...
struct_NV2080_CTRL_CMD_FB_GET_FB_REGION_FB_REGION_INFO.register_fields([
  ("base", NvU64, 0),
  ("limit", NvU64, 8),
  ("reserved", NvU64, 16),
  ("performance", NvU32, 24),
  ("supportCompressed", NvBool, 28),
  ("supportISO", NvBool, 29),
  ("bProtected", NvBool, 30),
  ("blackList", NV2080_CTRL_CMD_FB_GET_FB_REGION_SURFACE_MEM_TYPE_FLAG, 31),
])
struct_NV2080_CTRL_CMD_FB_GET_FB_REGION_INFO_PARAMS.register_fields([
  ("numFBRegions", NvU32, 0),
  ("fbRegion", c.Array[NV2080_CTRL_CMD_FB_GET_FB_REGION_FB_REGION_INFO, Literal[16]], 8),
])
...
struct_NV0080_CTRL_GPU_GET_SRIOV_CAPS_PARAMS.register_fields([
  ("totalVFs", NvU32, 0),
  ("firstVfOffset", NvU32, 4),
  ("vfFeatureMask", NvU32, 8),
  ("FirstVFBar0Address", NvU64, 16),
  ("FirstVFBar1Address", NvU64, 24),
  ("FirstVFBar2Address", NvU64, 32),
  ("bar0Size", NvU64, 40),
  ("bar1Size", NvU64, 48),
  ("bar2Size", NvU64, 56),
  ("b64bitBar0", NvBool, 64),
  ("b64bitBar1", NvBool, 65),
  ("b64bitBar2", NvBool, 66),
  ("bSriovEnabled", NvBool, 67),
  ("bSriovHeavyEnabled", NvBool, 68),
  ("bEmulateVFBar0TlbInvalidationRegister", NvBool, 69),
  ("bClientRmAllocatedCtxBuffer", NvBool, 70),
  ("bNonPowerOf2ChannelCountSupported", NvBool, 71),
  ("bVfResizableBAR1Supported", NvBool, 72),
])
struct_GspStaticConfigInfo_t.register_fields([
  ("grCapsBits", c.Array[NvU8, Literal[23]], 0),
  ("gidInfo", NV2080_CTRL_GPU_GET_GID_INFO_PARAMS, 24),
  ("SKUInfo", NV2080_CTRL_BIOS_GET_SKU_INFO_PARAMS, 292),
  ("fbRegionInfoParams", NV2080_CTRL_CMD_FB_GET_FB_REGION_INFO_PARAMS, 344),
  ("sriovCaps", NV0080_CTRL_GPU_GET_SRIOV_CAPS_PARAMS, 1120),
  ("sriovMaxGfid", NvU32, 1200),
  ("engineCaps", c.Array[NvU32, Literal[3]], 1204),
  ("poisonFuseEnabled", NvBool, 1216),
  ("fb_length", NvU64, 1224),
  ("fbio_mask", NvU64, 1232),
  ("fb_bus_width", NvU32, 1240),
  ("fb_ram_type", NvU32, 1244),
  ("fbp_mask", NvU64, 1248),
  ("l2_cache_size", NvU32, 1256),
  ("gpuNameString", c.Array[NvU8, Literal[64]], 1260),
  ("gpuShortNameString", c.Array[NvU8, Literal[64]], 1324),
  ("gpuNameString_Unicode", c.Array[NvU16, Literal[64]], 1388),
  ("bGpuInternalSku", NvBool, 1516),
  ("bIsQuadroGeneric", NvBool, 1517),
  ("bIsQuadroAd", NvBool, 1518),
  ("bIsNvidiaNvs", NvBool, 1519),
  ("bIsVgx", NvBool, 1520),
  ("bGeforceSmb", NvBool, 1521),
  ("bIsTitan", NvBool, 1522),
  ("bIsTesla", NvBool, 1523),
  ("bIsMobile", NvBool, 1524),
  ("bIsGc6Rtd3Allowed", NvBool, 1525),
  ("bIsGc8Rtd3Allowed", NvBool, 1526),
  ("bIsGcOffRtd3Allowed", NvBool, 1527),
  ("bIsGcoffLegacyAllowed", NvBool, 1528),
  ("bIsMigSupported", NvBool, 1529),
  ("RTD3GC6TotalBoardPower", NvU16, 1530),
  ("RTD3GC6PerstDelay", NvU16, 1532),
  ("bar1PdeBase", NvU64, 1536),
  ("bar2PdeBase", NvU64, 1544),
  ("bVbiosValid", NvBool, 1552),
  ("vbiosSubVendor", NvU32, 1556),
  ("vbiosSubDevice", NvU32, 1560),
  ("bPageRetirementSupported", NvBool, 1564),
  ("bSplitVasBetweenServerClientRm", NvBool, 1565),
  ("bClRootportNeedsNosnoopWAR", NvBool, 1566),
  ("displaylessMaxHeads", VIRTUAL_DISPLAY_GET_NUM_HEADS_PARAMS, 1568),
  ("displaylessMaxResolution", VIRTUAL_DISPLAY_GET_MAX_RESOLUTION_PARAMS, 1576),
  ("displaylessMaxPixels", NvU64, 1592),
  ("hInternalClient", NvHandle, 1600),
  ("hInternalDevice", NvHandle, 1604),
  ("hInternalSubdevice", NvHandle, 1608),
  ("bSelfHostedMode", NvBool, 1612),
  ("bAtsSupported", NvBool, 1613),
  ("bIsGpuUefi", NvBool, 1614),
  ("bIsEfiInit", NvBool, 1615),
  ("ecidInfo", c.Array[EcidManufacturingInfo, Literal[2]], 1616),
  ("fwWprLayoutOffset", FW_WPR_LAYOUT_OFFSET, 1640),
])
...
struct_GspSystemInfo.register_fields([
  ("gpuPhysAddr", NvU64, 0),
  ("gpuPhysFbAddr", NvU64, 8),
  ("gpuPhysInstAddr", NvU64, 16),
  ("gpuPhysIoAddr", NvU64, 24),
  ("nvDomainBusDeviceFunc", NvU64, 32),
  ("simAccessBufPhysAddr", NvU64, 40),
  ("notifyOpSharedSurfacePhysAddr", NvU64, 48),
  ("pcieAtomicsOpMask", NvU64, 56),
  ("consoleMemSize", NvU64, 64),
  ("maxUserVa", NvU64, 72),
  ("pciConfigMirrorBase", NvU32, 80),
  ("pciConfigMirrorSize", NvU32, 84),
  ("PCIDeviceID", NvU32, 88),
  ("PCISubDeviceID", NvU32, 92),
  ("PCIRevisionID", NvU32, 96),
  ("pcieAtomicsCplDeviceCapMask", NvU32, 100),
  ("oorArch", NvU8, 104),
  ("clPdbProperties", NvU64, 112),
  ("Chipset", NvU32, 120),
  ("bGpuBehindBridge", NvBool, 124),
  ("bFlrSupported", NvBool, 125),
  ("b64bBar0Supported", NvBool, 126),
  ("bMnocAvailable", NvBool, 127),
  ("chipsetL1ssEnable", NvU32, 128),
  ("bUpstreamL0sUnsupported", NvBool, 132),
  ("bUpstreamL1Unsupported", NvBool, 133),
  ("bUpstreamL1PorSupported", NvBool, 134),
  ("bUpstreamL1PorMobileOnly", NvBool, 135),
  ("bSystemHasMux", NvBool, 136),
  ("upstreamAddressValid", NvU8, 137),
  ("FHBBusInfo", BUSINFO, 138),
  ("chipsetIDInfo", BUSINFO, 148),
  ("acpiMethodData", ACPI_METHOD_DATA, 160),
  ("hypervisorType", NvU32, 836),
  ("bIsPassthru", NvBool, 840),
  ("sysTimerOffsetNs", NvU64, 848),
  ("gspVFInfo", GSP_VF_INFO, 856),
  ("bIsPrimary", NvBool, 896),
  ("isGridBuild", NvBool, 897),
  ("pcieConfigReg", GSP_PCIE_CONFIG_REG, 900),
  ("gridBuildCsp", NvU32, 904),
  ("bPreserveVideoMemoryAllocations", NvBool, 908),
  ("bTdrEventSupported", NvBool, 909),
  ("bFeatureStretchVblankCapable", NvBool, 910),
  ("bEnableDynamicGranularityPageArrays", NvBool, 911),
  ("bClockBoostSupported", NvBool, 912),
  ("bRouteDispIntrsToCPU", NvBool, 913),
  ("hostPageSize", NvU64, 920),
])
...
FALCON_APPLICATION_INTERFACE_HEADER_V1.register_fields([
  ("version", NvU8, 0),
  ("headerSize", NvU8, 1),
  ("entrySize", NvU8, 2),
  ("entryCount", NvU8, 3),
...
FALCON_APPLICATION_INTERFACE_DMEM_MAPPER_V3.register_fields([
  ("signature", NvU32, 0),
  ("version", NvU16, 4),
  ("size", NvU16, 6),
  ("cmd_in_buffer_offset", NvU32, 8),
  ("cmd_in_buffer_size", NvU32, 12),
  ("cmd_out_buffer_offset", NvU32, 16),
  ("cmd_out_buffer_size", NvU32, 20),
  ("nvf_img_data_buffer_offset", NvU32, 24),
  ("nvf_img_data_buffer_size", NvU32, 28),
  ("printfBufferHdr", NvU32, 32),
  ("ucode_build_time_stamp", NvU32, 36),
  ("ucode_signature", NvU32, 40),
  ("init_cmd", NvU32, 44),
  ("ucode_feature", NvU32, 48),
  ("ucode_cmd_mask0", NvU32, 52),
  ("ucode_cmd_mask1", NvU32, 56),
  ("multiTgtTbl", NvU32, 60),
])
...
struct_BIT_HEADER_V1_00.register_fields([
  ("Id", ctypes.c_uint16, 0),
  ("Signature", ctypes.c_uint32, 2),
  ("BCD_Version", ctypes.c_uint16, 6),
  ("HeaderSize", ctypes.c_ubyte, 8),
  ("TokenSize", ctypes.c_ubyte, 9),
  ("TokenEntries", ctypes.c_ubyte, 10),
  ("HeaderChksum", ctypes.c_ubyte, 11),
])
...
struct_BIT_TOKEN_V1_00.register_fields([
  ("TokenId", ctypes.c_ubyte, 0),
  ("DataVersion", ctypes.c_ubyte, 1),
  ("DataSize", ctypes.c_uint16, 2),
  ("DataPtr", ctypes.c_uint32, 4),
])
...
FALCON_UCODE_TABLE_HDR_V1.register_fields([
  ("Version", ctypes.c_ubyte, 0),
  ("HeaderSize", ctypes.c_ubyte, 1),
  ("EntrySize", ctypes.c_ubyte, 2),
  ("EntryCount", ctypes.c_ubyte, 3),
  ("DescVersion", ctypes.c_ubyte, 4),
  ("DescSize", ctypes.c_ubyte, 5),
])
...
FALCON_UCODE_DESC_V3.register_fields([
  ("Hdr", FALCON_UCODE_DESC_HEADER, 0),
  ("StoredSize", ctypes.c_uint32, 4),
  ("PKCDataOffset", ctypes.c_uint32, 8),
  ("InterfaceOffset", ctypes.c_uint32, 12),
  ("IMEMPhysBase", ctypes.c_uint32, 16),
  ("IMEMLoadSize", ctypes.c_uint32, 20),
  ("IMEMVirtBase", ctypes.c_uint32, 24),
  ("DMEMPhysBase", ctypes.c_uint32, 28),
  ("DMEMLoadSize", ctypes.c_uint32, 32),
  ("EngineIdMask", ctypes.c_uint16, 36),
  ("UcodeId", ctypes.c_ubyte, 38),
  ("SignatureCount", ctypes.c_ubyte, 39),
  ("SignatureVersions", ctypes.c_uint16, 40),
  ("Reserved", ctypes.c_uint16, 42),
])
...
FWSECLIC_READ_VBIOS_DESC.register_fields([
  ("version", NvU32, 0),
  ("size", NvU32, 4),
  ("gfwImageOffset", NvU64, 8),
  ("gfwImageSize", NvU32, 16),
  ("flags", NvU32, 20),
])
...
FWSECLIC_FRTS_REGION_DESC.register_fields([
  ("version", NvU32, 0),
  ("size", NvU32, 4),
  ("frtsRegionOffset4K", NvU32, 8),
  ("frtsRegionSize", NvU32, 12),
  ("frtsRegionMediaType", NvU32, 16),
])
...
struct__PCI_EXP_ROM_STANDARD.register_fields([
  ("sig", NvU16, 0),
  ("reserved", c.Array[NvU8, Literal[22]], 2),
  ("pciDataStrucPtr", NvU16, 24),
  ("sizeOfBlock", NvU32, 26),
])
...
struct__PCI_EXP_ROM_NBSI.register_fields([
  ("sig", NvU16, 0),
  ("reserved", c.Array[NvU8, Literal[20]], 2),
  ("nbsiDataOffset", NvU16, 22),
  ("pciDataStrucPtr", NvU16, 24),
  ("sizeOfBlock", NvU32, 26),
])
...
struct__PCI_DATA_STRUCT.register_fields([
  ("sig", NvU32, 0),
  ("vendorID", NvU16, 4),
  ("deviceID", NvU16, 6),
  ("deviceListPtr", NvU16, 8),
  ("pciDataStructLen", NvU16, 10),
  ("pciDataStructRev", NvU8, 12),
  ("classCode", c.Array[NvU8, Literal[3]], 13),
  ("imageLen", NvU16, 16),
  ("vendorRomRev", NvU16, 18),
  ("codeType", NvU8, 20),
  ("lastImage", NvU8, 21),
  ("maxRunTimeImageLen", NvU16, 22),
])
...
struct__NV_PCI_DATA_EXT_STRUCT.register_fields([
  ("signature", NvU32, 0),
  ("nvPciDataExtRev", NvU16, 4),
  ("nvPciDataExtLen", NvU16, 6),
  ("subimageLen", NvU16, 8),
  ("privLastImage", NvU8, 10),
  ("flags", NvU8, 11),
])
...
IS_VALID_PCI_DATA_SIG = lambda sig: (
  (sig == PCI_DATA_STRUCT_SIGNATURE) or (sig == PCI_DATA_STRUCT_SIGNATURE_NV) or (sig == PCI_DATA_STRUCT_SIGNATURE_NV2)
)  # type: ignore
